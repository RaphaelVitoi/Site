...
/**
 * IDENTITY: O Protocolo Smart Sniper v4.2 Gold
          ...
          <GlassPanel className="max-w-5xl mx-auto p-10 md:p-16 rounded-4xl bg-bg-panel/60 border-white/5 shadow-2xl relative overflow-hidden group/manifesto">
            ...
            <div className="prose prose-invert prose-indigo lg:prose-xl max-w-none relative z-10">
              <p className="text-indigo-100/80 leading-loose">
                O &quot;Grind&quot; tradicional morreu. A velha escola ensinava
                que para vencer no poker você precisava abrir 15 telas, jogar 12
                horas por dia e aceitar uma variância brutal em nome do
                &quot;longo prazo&quot;. Este documento apresenta a antítese
                dessa ideia. O{" "}
                <strong className="text-white">Protocolo Smart Sniper</strong>{" "}
                não foi desenhado para gerar rake; foi desenhado para gerar{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.8fr] gap-12 max-w-7xl mx-auto w-full items-start">
            <div className="glass-panel p-10 md:p-12 rounded-4xl bg-bg-panel/40 border-white/5 shadow-xl relative overflow-hidden group/volume">
              ...
              <p className="text-indigo-100/70 leading-relaxed mb-10 font-medium">
                ...
                demonstra que a performance humana segue uma curva de U
                invertido. Acima de 8 telas, o edge técnico desaparece e o
                cérebro entra em C-Game automático.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
              <div className="space-y-6">
                ...
                <p className="text-text-dim leading-relaxed font-medium">
                  O gasto total de domingo deve ser igual ao gasto médio
                  semanal, impedindo que um dia ruim comprometa meses de
                  solvência.
                </p>
              </div>
              <div className="space-y-6">
...
function PillarCard({
  ...
  const colorClasses = {
    ...
    indigo:
      "text-accent-indigo-light bg-accent-indigo/10 border-accent-indigo/20",
    violet:
      "text-accent-violet-light bg-accent-violet/10 border-accent-violet/20",
