...
// Contexto EstÃ¡tico/Dados Base (Muda com as interaÃ§Ãµes de spot)
...
// Contexto de MÃ©tricas Calculadas (Muda conforme FGS e Perspectiva)
...
// Contexto do Motor WASM / Equity (Muda frequentemente durante o cÃ¡lculo - FricÃ§Ã£o Zero)
export interface ISotaWasmContext {
  ...
  // SOTA: Matriz de InsolvÃªncia (WASM)
  insolvencyMatrixData?:
    | import("./hooks/useQuantumEngine").InsolvencyMetrics
    | null;
  isCalculatingInsolvency?: boolean;
  dispatchInsolvencyMatrix?: (
    payload: import("./hooks/useQuantumEngine").InsolvencyPayload
  ) => void; // NOSONAR

  // SOTA: DistorÃ§Ã£o de Nash e Despacho ICM (WASM)
  nashResults?: import("./hooks/useQuantumEngine").NashDistortionResults | null;
  dispatchIcmDistortion?: (
    payload: import("./hooks/useQuantumEngine").DistortionPayload,
  ) => void;
}

export const SotaSpotContext = createContext<ISotaSpotContext | null>(null);
export const SotaMetricsContext = createContext<ISotaMetricsContext | null>(
  null,
);
