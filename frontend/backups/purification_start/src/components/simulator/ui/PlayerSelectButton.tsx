...
function buildPlayerRowDisplay(
  isA: boolean,
  isD: boolean,
  playerId: string,
): PlayerRowDisplay {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span
          className={`text-[0.75rem] font-bold leading-tight ${display.nameColor}`}
        >
          {player.pos}
        </span>
      </div>
      ...
      >
        {player.bb.toFixed(1)}
        <span className="text-[0.58rem] font-semibold ml-0.5 opacity-50">
          bb
        </span>
      </span>
    </button>
