 ...
 */
function applyFrequencyPropagation(sourceDeltas: Partial<ChipEvFreqs>, targetFreqs: ChipEvFreqs, attenuation: number): ChipEvFreqs {
 ...
 */
function calculateFreqDeltas(oldFreqs: ChipEvFreqs, newFreqs: ChipEvFreqs): { deltas: Partial<ChipEvFreqs>, hasChange: boolean; } {
...
function propagateFrequencies(prev: StreetChipEvFreqs, street: keyof StreetChipEvFreqs, deltas: Partial<ChipEvFreqs>): StreetChipEvFreqs {
...
export function useFrequencyPropagation(setStreetFreqs: React.Dispatch<React.SetStateAction<StreetChipEvFreqs>>) {
