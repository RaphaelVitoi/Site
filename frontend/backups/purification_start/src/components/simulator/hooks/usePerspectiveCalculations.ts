...
export function usePerspectiveCalculations({
    ...
    }, [stacks, prizes, potSize, heroCost, winProb, realization, edgeBase, bountyValue, kappa, numPlayers, isNearPayjump, blindsRising, humanNoiseFactor]);
    ...
    const chartData = useMemo(() => {
        ...
        return points;
    }, [stacks, prizes, potSize, heroCost, realization, edgeBase, bountyValue, kappa, numPlayers, isNearPayjump, blindsRising, humanNoiseFactor]);
