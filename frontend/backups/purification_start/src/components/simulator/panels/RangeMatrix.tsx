        ...
        <div className="glass-panel flex flex-col gap-10 p-6 sm:p-8 lg:p-12 rounded-4xl bg-bg-panel/80 backdrop-blur-xl border border-white/10 shadow-2xl relative overflow-hidden transition-all duration-300">
                            ...
                            {RANKS.map((r2, j) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isDeath && ci !== null && (
                                            <span className="absolute bottom-0.5 right-0.5 text-[0.4rem] font-bold text-accent-danger/80 leading-none">Cáµ¢ {ci.toFixed(2)}</span>
                                        )}
                                    </button>
                                );
                            })}
            ...
            <div className="flex items-start gap-6 p-8 bg-black/40 border border-white/5 rounded-3xl shadow-inner group/guide hover:border-accent-indigo/20 transition-all duration-500">
                ...
                <div className="flex flex-col gap-2">
                    <h5 className="text-white uppercase tracking-[0.3em] text-[0.65rem] font-black m-0 group-hover/guide:text-accent-indigo-light transition-colors">Guia TopolÃ³gico de Colapso</h5>
                    <p className="text-[0.75rem] text-text-muted leading-relaxed m-0 font-medium">
                        Este painel simula o colapso heurÃ­stico do range sob pressÃ£o ICM. MÃ£os em <strong className="text-accent-danger uppercase tracking-tighter">Death</strong> representam a zona de insolvÃªncia mecÃ¢nica onde o valuation do pote nÃ£o suporta a pressÃ£o estrutural do motor de simulaÃ§Ã£o.
                    </p>
                </div>
            </div>
        </div>
