      ...
      <div className="flex flex-col items-center gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-text-muted text-lg max-w-xl mx-auto leading-relaxed font-medium italic">
            O seu modelo cognitivo foi testado contra a topologia sistêmica do
            Paradigma Vitoi.
          </p>
        </div>
        ...
        <motion.button
          ...
          {...({
            onClick: onRestart,
            className:
              "mt-6 px-12 py-5 bg-white/5 text-text-bright border border-white/10 rounded-2xl cursor-pointer font-black transition-all text-[0.7rem] uppercase tracking-[0.3em] inline-flex items-center gap-4 hover:bg-white/10 hover:border-white/20 active:bg-white/5 shadow-xl",
          } as any)}
        >
