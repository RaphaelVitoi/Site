		...
		return (
			...
			>
				...
				<p className="text-[0.65rem] text-text-darker mt-6 max-w-sm mx-auto leading-relaxed relative z-10">
					A sobrevivência no Poker exige a preservação do valuation da stack. Um EV Loss
					alto indica falhas na leitura das Reverse Implied Odds ou da aversão à perda de
					ICM.
				</p>
			</motion.div>
		);
