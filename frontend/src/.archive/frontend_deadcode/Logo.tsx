		...
		>
			<div className="relative flex items-center justify-center w-9 h-9 rounded-xl bg-linear-to-br from-bg-panel to-bg-deep border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_0_20px_rgba(99,102,241,0.2)] group-hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_0_30px_rgba(99,102,241,0.6)] group-hover:border-accent-indigo/50 transition-all duration-500 overflow-hidden">
				...
				>
					...
					<circle
						...
						r="3"
						fill="currentColor"
						className="text-accent-indigo group-hover:text-accent-fuchsia transition-colors duration-500 drop-shadow-[0_0_5px_rgba(99,102,241,0.8)]"
					/>
					<defs>
						<linearGradient
							id="logo-gradient"
			...
			<div className="flex flex-col">
				<span className="hidden sm:inline-flex text-xl font-black tracking-tighter text-gradient-sota leading-none">
					Poker
					<span className="font-medium text-text-muted group-hover:text-accent-indigo-light transition-colors duration-500">
						Racional
					</span>
				</span>
			</div>
