...
import { calculateMapaICM, calculatePerspectivaVitoi, PerspectivaInput } from '../../lib/perspectiva';
...
describe('calculatePerspectivaVitoi - Validação de Teoremas SOTA (D1 a D6)', () => {
  const baseInput: PerspectivaInput = {
    stacks: [1000, 3000, 200, 100], // SOTA: Mesa assimétrica (Predador = 3000, Presas = 200/100, Hero = 1000)
