			...
			<div className="sota-container py-12">
				<GlassPanel className="p-8">
					<div className="flex items-center gap-4 mb-8">
						...
						<span className="text-[0.6rem] font-black text-text-muted uppercase tracking-[0.3em]">
							Índice Analítico
						</span>
						<span className="flex-1 h-px bg-linear-to-r from-transparent via-accent-indigo/20 to-transparent" />
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
						{toc.map(({ num, id, label, title, desc }) => (
							<a
								key={id}
								href={`#${id}`}
								className="group p-4 rounded-xl border border-white/5 bg-white/2 hover:bg-white/5 hover:border-accent-indigo/30 transition-all"
							>
								<div className="flex justify-between items-start mb-3">
									<span className="text-xl font-black text-text-muted group-hover:text-accent-indigo transition-colors">
										{num}
									</span>
									<span className="text-[0.55rem] font-bold text-accent-indigo-light uppercase tracking-widest bg-accent-indigo/10 px-2 py-0.5 rounded">
										{label}
									</span>
								</div>
				...
				<div className="sota-container pb-12">
					<GlassPanel className="p-8 sm:p-12 lg:p-16">
						<div className="prose prose-invert prose-lg max-w-none text-text-muted">
							<p>
								ICM impõe assimetria ao valor das fichas: cada chip perdido vale
								mais do que cada chip ganho. Essa assimetria pode ser expressa de
								duas formas. O <strong>Risk Premium (RP)</strong> e o{' '}
								<strong>Bubble Factor (BF)</strong> medem o mesmo fenômeno.
							</p>

							<h3 className="text-text-bright font-heading mt-10 mb-4">
								Risk Premium
							</h3>
							<p>
								O RP é a equity adicional, acima dos pot odds puros, que um jogador
								precisa ter para justificar um call de all-in sob a pressão do ICM.
							</p>
							...
							<div className="bg-accent-emerald/10 border-l-4 border-accent-emerald p-8 my-10 rounded-r-2xl">
								...
								<p className="text-text-main m-0 leading-relaxed text-sm">
									Exemplo: RP de 21% &rarr; BF = 100 / 79 &asymp; 1,27. No
									framework VITOI, o RP é a unidade base por sua clareza
					...
					<GlassPanel className="p-8 sm:p-12 lg:p-16">
						<div className="prose prose-invert prose-lg max-w-none text-text-muted">
							<p>
								Responde:{' '}
								<em>
									o que posso concretamente buscar neste cenário, em termos de
									probabilidades, riscos e ganhos?
								</em>{' '}
								É a medida da expectativa realizável de melhora de posição no
								torneio.
							</p>
							...
							<h3 className="text-text-bright font-heading mt-10 mb-4">
								EV do fold como threshold
							</h3>
							<p>
								Em ICM, o EV do fold <em>pode ser positivo</em>: foldar quando há
								short stacks prestes a ser eliminados gera payjumps passivos. Uma
								ação só é correta se superar este baseline.
							</p>
						</div>
					</GlassPanel>
				</div>
			...
			<div id="expectativa" className="scroll-mt-24">
				...
				<div className="sota-container pb-12">
					<GlassPanel className="p-8 sm:p-12 lg:p-16">
						<div className="prose prose-invert prose-lg max-w-none text-text-muted">
							<p>
								A Expectativa Matemática é a camada preditiva. Ela captura a{' '}
								<strong>cadeia de consequências encadeadas</strong> — o quequele
								outcome específico abre ou fecha para o restante da trajetória.
							</p>

							<h3 className="text-text-bright font-heading mt-10 mb-4">
								Table Draw e Antevisão
							</h3>
							<p>
								A <strong>Antevisão</strong> integra variáveis que solvers ignoram:
								o salto iminente de blinds (t&minus;3) e o custo posicional da
								órbita seguinte. Essas dimensões alteram a urgência da ação
								presente.
							</p>
						</div>
					</GlassPanel>
			...
			<div id="perspectiva" className="scroll-mt-24">
				...
				<div className="sota-container pb-12">
					<GlassPanel className="p-8 sm:p-12 lg:p-16">
						<div className="prose prose-invert prose-lg max-w-none text-text-muted">
							<p>
								A Perspectiva Matemática encapsula todas as camadas anteriores em
								uma única medida fechada, sem abstração residual.
							</p>
							...
							<p>
								Dobrar o stack de um short{' '}
								<strong>devolve a complexidade ao oponente</strong>. Um call de EV
								marginalmente positivo pode ser um erro sistêmico se ressuscitar um
								adversário taticamente neutralizado.
							</p>
						</div>
					</GlassPanel>
				</div>
