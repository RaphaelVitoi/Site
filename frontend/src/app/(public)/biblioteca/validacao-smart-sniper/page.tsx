/**
 * IDENTITY: Validação Científica do Smart Sniper (GOLD v6.2.1)
...
export const metadata = {
	...
	description:
		'Análise comparativa via Monte Carlo, Índice de Sharpe e Teoria de Portfólio aplicada ao poker MTT GOLD v6.2.1.',
};

const articleSchema = {
	'@context': 'https://schema.org',
	'@type': 'TechArticle',
	headline: 'Validação Científica do Protocolo Smart Sniper GOLD: v6.2.1',
	description:
