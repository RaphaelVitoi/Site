    ...
    <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body">
      ...
      <div className="sota-container pb-24">
        <div className="flex flex-col md:flex-row justify-between border-t border-white/5 pt-12 gap-8">
          <Link href="/biblioteca" className="text-accent-indigo-light text-[0.6rem] font-black tracking-[0.2em] uppercase flex items-center gap-2 hover:text-text-bright transition-all">
            <i className="fa-solid fa-arrow-left" /> VOLTAR À BIBLIOTECA
          </Link>
          <div className="flex flex-col items-end opacity-20">
            <span className="text-[0.5rem] font-mono uppercase tracking-widest">Protocolo VITOI</span>
            <span className="text-[0.5rem] font-mono uppercase tracking-widest">Quantum Analytics Layer</span>
          </div>
        </div>
      </div>
    </div>
