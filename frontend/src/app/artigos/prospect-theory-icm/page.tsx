        ...
        <div className="min-h-screen bg-bg-base text-text-main pb-24">
            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="glass-panel p-8 md:p-12 prose prose-invert prose-lg max-w-none font-body">
                    ...
                    <h2 className="text-2xl font-bold text-text-bright font-heading mt-12 mb-6 border-b border-white/10 pb-4">
                        3. O Paradigma da Perspectiva Matemática (VITOI)
                    </h2>
                    <p>
                        A Perspectiva Matemática não é apenas um cálculo de equity; é a síntese final de um sistema complexo. No Laboratório VITOI, a tomada de decisão evolui em quatro camadas de resolução:
                    </p>
                    <ol>
                        <li><strong>ICM<sub>ev</sub></strong> (Snapshot): A métrica estática básica (&quot;O que tenho agora?&quot;).</li>
                        <li><strong>Esperança Matemática (Lógica):</strong> Antevisão estratégica e mitigação de ameaças (nêmesis).</li>
                        <li><strong>Expectativa Matemática (Preditiva):</strong> Projeção do <em>Future Game Simulation</em> (FGS).</li>
                        <li><strong>Perspectiva Matemática (Síntese):</strong> O output de rigor absoluto que dita a ação ótima.</li>
                    </ol>

                    <div className="bg-accent-indigo/5 border-l-4 border-accent-indigo p-8 my-10 rounded-r-2xl">
                        <h4 className="mt-0 text-accent-indigo-light font-bold text-lg mb-4 font-heading">O Teto de Nash (D5)</h4>
                        <p className="text-text-main leading-relaxed m-0 text-sm">
                            Um dos marcos do Paradigma VITOI é a prova matemática do <strong>Teto de 41%</strong>. Sob pressão extrema de ICM no River, a estrutura de prêmios standard impõe um limite físico: é estruturalmente impossível necessitar de mais do que ~41% de equidade para justificar um call, independentemente da agressividade do oponente.
                        </p>
                    </div>

                    <h2 className="text-2xl font-bold text-text-bright font-heading mt-12 mb-6 border-b border-white/10 pb-4">
                        4. O Desafio Computacional: A Explosão do Malmuth-Harville
                    </h2>
                    <p>
