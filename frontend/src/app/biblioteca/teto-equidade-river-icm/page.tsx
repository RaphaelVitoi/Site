/**
 * IDENTITY: Prova Matemática do Teto de Equidade
 * PATH: src/app/biblioteca/teto-equidade-river-icm/page.tsx
 * ROLE: Página do artigo técnico sobre limites assintóticos de equidade no river.
 */
...
const content = `# PROVA MATEMÁTICA: O Teto de Equidade no River sob Pressão de ICM
...
export default function TetoEquidadePage() {
  return (
    <div className="min-h-screen bg-bg-base text-text-bright">
      <ContentPageHeader
        title="O Teto de Equidade"
        subtitle="Prova Matemática: Limites assintóticos de defesa no river sob pressão extrema de ICM."
        category="Matemática"
      ...
      <ContentFooter 
        shareTitle="O Teto de Equidade | Raphael Vitoi"
        shareUrl="https://www.raphaelvitoi.com/biblioteca/teto-equidade-river-icm"
