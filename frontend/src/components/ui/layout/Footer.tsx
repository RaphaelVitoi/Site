...
export default function Footer() {
	...
	return (
		<footer
			id="contato"
			className="relative border-t border-white/5 bg-bg-deep pt-32 pb-16 overflow-hidden z-10 group/footer"
		>
			{/* SOTA: Geometria Técnica de Fundo (Grid Cibernético) */}
			<div className="absolute inset-0 bg-[linear-gradient(rgba(99,102,241,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(99,102,241,0.02)_1px,transparent_1px)] bg-size-[40px_40px] mask-[radial-gradient(ellipse_at_bottom,black_40%,transparent_100%)] pointer-events-none opacity-60" />
			<div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,rgba(99,102,241,0.12),transparent_70%)] pointer-events-none transition-all duration-1000 group-hover/footer:bg-[radial-gradient(ellipse_at_bottom,rgba(99,102,241,0.18),transparent_70%)]" />
				...
				<div className="mb-16 flex flex-col items-center">
					...
					>
						...
						<div className="flex flex-col items-center justify-center">
							...
							<span className="text-[0.7rem] font-black uppercase tracking-[0.5em] text-accent-indigo-light mt-4 leading-none opacity-80 group-hover:text-glow-indigo transition-all duration-500">
