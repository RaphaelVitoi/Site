						...
						>
							...
							<div className="flex flex-col justify-center">
								<div className="flex items-center gap-2">
									<span className="text-[1.15rem] font-black tracking-tighter text-white leading-none group-hover:text-glow-indigo transition-all duration-500">
										POKER{' '}
										<span className="font-light text-white/70 tracking-widest ml-0.5 group-hover:text-white transition-colors duration-500">
											RACIONAL
										</span>
									</span>
									<div
										className={`w-1.5 h-1.5 rounded-full ${gemmaOnline ? 'bg-accent-emerald animate-pulse shadow-[0_0_10px_var(--color-accent-emerald)]' : 'bg-rose-500/40'}`}
										title={gemmaOnline ? 'Oráculo Online' : 'Oráculo Offline'}
									/>
								</div>
								<span className="text-[0.55rem] font-bold uppercase tracking-[0.35em] text-accent-indigo-light mt-1.5 leading-none group-hover:text-glow-indigo transition-all duration-500">
									Nexus System
								</span>
							</div>
						</Link>
