...
const InteractiveEquation = ({ s }: { readonly s: EquationData }) => {
  ...
  return (
    <div
      className="group/eq mt-2 flex cursor-help flex-col gap-2 border-t border-white/5 pt-4 select-none"
    ...
    >
      ...
      {hovered ? (
        <div className="text-text-dim animate-fade-in rounded-xl border border-white/10 bg-black/80 p-2.5 font-mono text-[0.42rem] leading-relaxed shadow-inner backdrop-blur-md">
        ...
        <p className="text-text-darker group-hover/eq:text-text-muted m-0 text-right text-[0.45rem] leading-tight font-black tracking-widest uppercase transition-colors">
