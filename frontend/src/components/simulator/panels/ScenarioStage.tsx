	...
	return (
		<div className="glass-panel animate-sota-in relative transition-all duration-700 hover:border-white/20 group/stage">
			...
			<div className="my-14 relative group/theory">
				...
				<div
					className={`relative p-12 rounded-4xl border transition-all duration-700 shadow-inner ${isNodelockB20 ? 'bg-accent-indigo/10 border-accent-indigo/30 shadow-accent-indigo/5' : 'bg-slate-950/50 border-white/5 hover:bg-slate-950/70 hover:border-white/10'} text-[1.05rem] leading-relaxed`}
				>
					{isNodelockB20 ? (
