...
describe( 'DireÃ§Ã£o das distorÃ§Ãµes ICM', () => {
  test( 'Î”RP positivo (IP sob mais pressÃ£o): apostas IP diminuem e checks aumentam (SOTA Physics)', () => {
  ...
  test( 'Î”RP negativo (OOP sob mais pressÃ£o): apostas IP aumentam (SOTA Physics, IP explora a pressão no OOP)', () => {
    const base = solveIcmDistortion( 10, 10, NEUTRO, 1 );
...
describe( 'aggressionFactor', () => {
  test( 'aggressionFactor altera frequÃªncias do IP (SOTA 8.0: IP reage logicamente Ã  pressÃ£o)', () => {
