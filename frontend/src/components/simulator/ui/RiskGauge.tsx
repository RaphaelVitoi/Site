...
export function RiskGauge({
	...
	let colorHex = '#6366f1'; // Indigo-500
	if (baseColor === 'pink') colorHex = '#ec4899'; // Pink-500
	...
	let strokeWidth = '2.5';
	if (isDeathZone) strokeWidth = '3.5';
	else if (isPredatorZone) strokeWidth = '3';

	let statusText = 'RP';
	if (isDeathZone) statusText = 'CRITICAL';
	else if (isPredatorZone) statusText = 'ATTACK';
	...
	if (isDeathZone) {
		...
		centerContent = (
			<i className="fa-solid fa-crosshairs text-3xl mb-1" style={{ color: colorHex }} />
		);
	}
	...
	return (
		<div className="flex flex-col items-center font-sans">
			...
			<div className="text-center">
				...
				<div className="font-serif text-xl font-bold text-white leading-tight">{pos}</div>
