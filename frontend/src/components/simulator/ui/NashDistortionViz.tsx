...
interface NashDistortionVizProps {
	streetName: string;
	nashData: IcmDistortionResult | null;
}

export const NashDistortionViz = ({ streetName, nashData }: Readonly<NashDistortionVizProps>) => {
		...
		<div className="flex flex-col gap-4 p-6 bg-black/60 rounded-3xl border border-white/5 shadow-2xl transition-all duration-500 hover:bg-black/80 hover:border-white/10 group">
			...
			<div className="flex justify-between text-[0.65rem] font-black font-mono mt-1 px-1">
				<div className="flex flex-col gap-0.5">
					<span className="text-text-darker uppercase text-[0.45rem] tracking-widest">
						Fold
					</span>
					<span className="text-accent-danger drop-shadow-[0_0_8px_rgba(244,63,94,0.4)] font-bold">
						{fPct}%
					</span>
				</div>
				<div className="flex flex-col gap-0.5 items-center">
					...
					<span className="text-accent-emerald drop-shadow-[0_0_8px_rgba(16,185,129,0.4)] font-bold">
						{cPct}%
					</span>
				</div>
				<div className="flex flex-col gap-0.5 items-end">
					...
					<span className="text-accent-indigo drop-shadow-[0_0_8px_rgba(99,102,241,0.4)] font-bold">
						{rPct}%
					</span>
				</div>
			</div>
