...
interface HeadingWithCopyProps extends React.HTMLAttributes<HTMLHeadingElement> {
    level: 2 | 3;
}

// Componente customizado para injetar a lógica de copiar link ao clicar no título
const HeadingWithCopy = ( { level, children, id, ...props }: HeadingWithCopyProps ) => {
...
const markdownComponents: Components = {
    h2: ( { node, ...props } ) => <HeadingWithCopy level={ 2 } { ...props } />,
    h3: ( { node, ...props } ) => <HeadingWithCopy level={ 3 } { ...props } />,
};
