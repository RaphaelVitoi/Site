...
export function solve_icm_distortion_binary(ip_rp: number, oop_rp: number, topologic_aggression: number, active_players: number, freqs: any): any;

export function solve_icm_distortion_v2(ip_rp: number, oop_rp: number, topologic_aggression: number, active_players: number, pot_size: number, street_idx: number, fold: number, _call: number, raise: number): Float64Array;

export function solve_icm_distortion_zerocopy(payload: Float64Array): Float64Array;

export function solve_insolvency_matrix_binary(villain_mask: Uint8Array, board: string, rp_factor: number, hero_invested: number, current_pot: number, active_players: number, iterations: number, seed: number, kappa: number): Array<any>;
...
export interface InitOutput {
    ...
    readonly quantumcfrengine_compute_cfr_heatmap: (a: number, b: number, c: number, d: number) => any;
    readonly quantumcfrengine_new: () => number;
    readonly solve_icm_distortion_binary: (a: number, b: number, c: number, d: number, e: any) => any;
    readonly solve_icm_distortion_v2: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => any;
    readonly solve_icm_distortion_zerocopy: (a: number, b: number) => any;
    readonly solve_insolvency_matrix_binary: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => any;
