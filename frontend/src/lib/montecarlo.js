...
function runSingleMonteCarloIteration(numPlayers, stacks, activePrizes, totalChips, totalEquity, isBusted) {
...
export function calculateIcmMonteCarlo(stacks, prizes, config = {}) {
    ...
    const isBusted = numPlayers > 30 ? new Array(numPlayers) : null;
