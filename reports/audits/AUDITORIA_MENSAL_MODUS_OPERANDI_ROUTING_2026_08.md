...
criado_em: 2026-08-27T15:06-03:00
commit: 4cce6758
classes: [interno, externo, medido]
fontes:
  - {fonte: llm/model_registry.py, consultado_em: 2026-08-27T15:06-03:00, versao_alvo: local}
  - {fonte: llm/routing_policy.py, consultado_em: 2026-08-27T15:06-03:00, versao_alvo: local}
  - {fonte: data/agents_manifest.json, consultado_em: 2026-08-27T15:06-03:00, versao_alvo: local}
ttl_dias: 90
config_medida:
  python: '3.14.6'
  modelos_auditados: 5
...
verificado:
  ...
  - cobertura de roteamento -- 19 agentes e 13 subagentes
...
> **Data de Execucao:** 2026-08-27 15:06:39
...
| :--- | :--- | :--- | :--- | :--- |
| `MODUS_OPERANDI.md` | Sim | 39284 B | Sim | Sim |
| `Site/MODUS_OPERANDI.md` | Sim | 12836 B | Sim | Sim |
...
Nenhuma das 8 rotas venceu o TTL na data desta execucao (2026-08-27). As ancoras declaradas em `llm/routing_policy.py` seguem dentro do prazo.
