...
### 5.3 Nash Ceiling
Em qualquer situação de MTT, a equidade de indiferença (Nash) é estruturalmente bloqueada em **41%**, impedindo a superestimação de calls marginais em cenários de alta pressão (bubble).
