...
async def get_agent_system_prompt(agent_name: str) -> str:
    ...
    def sync_compile() -> str:
        ...
        # Mesma fonte unica do orquestrador -- ver core.config.modelo_do_agente.
        # Antes daqui saia o `primary_model` do manifesto, e o agente era
        # informado de um modelo diferente daquele em que ia rodar.
