...
def calculate_perspectiva_vitoi_v7(
    current_equity_pct: float,
    delta_win_pct: float,
    delta_lose_pct: float,
    dynamic_ev_fold: float,
    ...
    **kwargs: float,
    ...
    """
    SOTA v7.0 GOLD: Wrapper de compatibilidade para o calculo da Perspectiva Matematica.
    """
    return compute_quantum_metrics(
        current_equity_pct=current_equity_pct,
        delta_win_pct=delta_win_pct,
        delta_lose_pct=delta_lose_pct,
        dynamic_ev_fold=dynamic_ev_fold,
