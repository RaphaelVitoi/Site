...
verificado:
  - contrato de estado, recuperacao ICMev e identidade H9 cobertos por testes unitarios locais
nao_verificado:
...
`TournamentState` exige massa de stacks positiva e prize pool positivo. Ele
nao contem habilidade, ranges, rake, bounties, historico de maos nem utilidade
de carreira: cada extensao deve declarar sua entrada e operador para que uma
comparacao nao esconda dupla contagem.
...
O benchmark rejeita rake, overlay, bounty, mystery bounty, reajuste livre de
payout ou qualquer mudanca de massa monetaria. Logo, ele nao estima ROI,
habilidade, field futuro ou justica normativa de late registration; ele apenas
garante que o caso-base nao perde valor contabil no caminho.
