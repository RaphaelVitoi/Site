...
> Gerado pelo @organizador | Data: 2026-03-24
...
- [`docs/reports/AUDITORIA_GLOBAL_SOTA_2026.md`](reports/AUDITORIA_GLOBAL_SOTA_2026.md) -> Auditoria global SOTA

## 5. Documentos de Governanca (A Alma do Sistema)
