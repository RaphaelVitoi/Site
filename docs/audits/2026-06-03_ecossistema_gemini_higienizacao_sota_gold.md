...
Dois atalhos de navegação criados em `C:\Users\Raphael\`:

| Junction | Target | Propósito |
|---|---|---|
| `Cerebro/` | `...\.gemini\antigravity\brain\` | Acesso direto ao histórico de conversas |
| `GeminiHub/` | `C:\Users\Raphael\.gemini\` | Acesso direto ao hub de configuração |
...
| Arquivo | Ação |
|---|---|
| `C:\Users\Raphael\.geminiignore` | **Criado** — bloqueia `Cerebro/`, `GeminiHub/`, dirs de sistema e pessoais |
...
|---|---|---|
| `C:\Users\Raphael\.geminiignore` | CRIADO | Bloqueio circular user-root |
...
| `C:\Users\Raphael\Cerebro` (junction) | CRIADO | Atalho → brain/ |
| `C:\Users\Raphael\GeminiHub` (junction) | CRIADO | Atalho → .gemini/ |
