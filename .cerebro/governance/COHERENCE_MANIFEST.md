...
**Arquivo:** `.cerebro/context/project-context.md`
...
- Referencia de integracao harmonica (apontando volta para project-context + GLOBAL_INSTRUCTIONS + CEREBRO.md)
...
**@architect** (FASE 00 - Topologia, Blueprint Estrutural & Visao de Produto)
...
| `.cerebro/governance/LIDERANCA_GOVERNANCE_RAPHAEL_MAVERICK_CHICO.md` | Documentacao estrutural completa |
...
- [X] `.cerebro/CEREBRO.md` - Identidade & Principios
- [X] `GLOBAL_INSTRUCTIONS.md` - Instrucoes Globais
- [X] `.cerebro/context/project-context.md` - Contexto & Papel
