...
| --- | --- | --- |
| Diagnostico rapido | nexus-status, nexus-keys, nexus-fallback 60 | [MAGENTA] |
| Operacao diaria | nexus '&lt;tarefa&gt;', start-worker, nexus-list | [VERDE] |
| Manutencao segura | nexus-checkdb, nexus-fallback-prune 7, nexus-backup | [AMARELO] |
| Governanca/Mapa | nexus-map, nexus-scripts, nexus-scripts-refresh | [CIANO] |
| Recovery controlado | stop-worker, start-worker -Force, nexus-fallback-prune-legacy | [VERMELHO] |
...
| scripts/control/.cerebro/autonomy.json | scripts/_legacy/autonomy.control.legacy.json | Estado legado fora da fonte oficial | MISSING | OK |
