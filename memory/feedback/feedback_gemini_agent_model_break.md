...
description: Gemini muda model dos agentes .cerebro/agents/*.md para strings invalidas - verificar apos cada sessao Gemini
type: feedback
---
...
**How to apply:** Apos qualquer sessao da Gemini que toque em `.cerebro/agents/*.md`, rodar `grep "^model:" .cerebro/agents/*.md` e verificar que todos os valores sao IDs validos. Corrigir imediatamente se necessario.
