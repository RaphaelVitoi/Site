...
Invoke-Step -Name "Python syntax check" -Action { uv run python -m py_compile web/middleware.py web/server.py }
Invoke-Step -Name "Python tests" -Action { uv run pytest -q }
