...
def get_model_status() -> dict:
    ...
    qwen_7b_installed = (ollama_dir / "qwen2.5-coder" / "7b").exists() or (ollama_dir / "qwen2.5-coder" / "7b-instruct-q5_K_M").exists()
    gemma_4b_installed = (ollama_dir / "gemma4" / "e4b").exists()
    gemma_31b_cloud_installed = (ollama_dir / "gemma4" / "31b-cloud").exists() or (ollama_dir / "gemma4" / "31b").exists()
