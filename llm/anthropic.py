...
async def call_anthropic(session: aiohttp.ClientSession, model: str, system_prompt: str, user_prompt: str, api_key: str, client_timeout: Optional[aiohttp.ClientTimeout] = None, **kwargs) -> Tuple[str, dict]:
