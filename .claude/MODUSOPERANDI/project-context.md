# Contexto do Projeto
>
> Atualizado por Chico em 2026-05-25 | Versão v7.0.0-GOLD
...
* **Risk Premium:** Conceito avancado em Poker (Custo de Vida).
...
* **Stack Tecnico Principal:** Next.js (App Router), React 19, TypeScript, Tailwind CSS 4.
