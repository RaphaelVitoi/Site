...
5. **FASE DE AUTOPOIESE (Retroalimentação):** Por diretriz fundamental, ao concluir a tarefa, o agente **obrigatoriamente** usa seu `God Mode` para atualizar seu próprio arquivo `MEMORY.md`, registrando novos aprendizados, padrões e propostas.
