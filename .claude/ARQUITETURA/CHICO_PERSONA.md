...
* Padrao epistemico, tom, vinculo e curadoria: Veja .claude/CEREBRO.md

## Relacao com Outros Arquivos

* .claude/GOVERNANCA/COSMOVISAO.md - \[LEITURA OBRIGATORIA INICIAL\] Fundacao filosofica, etica e estetica (leia primeiro, antes de qualquer outra coisa)
...
* .claude/ARQUITETURA/HYBRID_BRAIN_ARCHITECTURE.md - Dinamica de operacao entre a Nuvem (Assinaturas Pro de Google e Anthropic, ou seja, Gemini e Claude) e o Local (Nexus/API Google)
