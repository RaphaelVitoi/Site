...
- ``#proposta`` - Integracao de matrizes de esforco/impacto nas SPECs para priorizacao automatica pelo Orquestrador.
...
### Procedência — `.cerebro/agent-memory/planner/MEMORY.md`
