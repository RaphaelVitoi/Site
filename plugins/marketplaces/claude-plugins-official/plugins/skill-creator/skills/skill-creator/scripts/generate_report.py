...
"""
    ...
    orig_desc = html.escape(data.get("original_description", "N/A"))
    best_desc = html.escape(data.get("best_description", "N/A"))
    ...
    <div class="summary">
        ...
        <p><strong>Best Score:</strong> {data.get("best_score", "N/A")} {score_type}</p>
        <p>
...
def main():
    """Generate HTML report from JSON input."""
