...
See [TOOLSET.md](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/TOOLSET.md) for a comprehensive list.

## 🔌 Installation & Getting Started

For the best experience, use Visual Studio Code and GitHub Copilot. See the [getting started documentation](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/GETTINGSTARTED.md) to use our MCP Server with other tools such as Visual Studio 2022, Claude Code, Cursor, Opencode, and Kilocode.
...
![start mcp server](https://raw.githubusercontent.com/microsoft/azure-devops-mcp/main/docs/media/start-mcp-server.gif)

In chat, switch to [Agent Mode](https://code.visualstudio.com/blogs/2025/02/24/introducing-copilot-agent-mode).

Click "Select Tools" and choose the available tools.

![configure mcp server tools](https://raw.githubusercontent.com/microsoft/azure-devops-mcp/main/docs/media/configure-mcp-server-tools.gif)
...
See the [getting started documentation](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/GETTINGSTARTED.md) to use our MCP Server with other tools such as Visual Studio 2022, Claude Code, and Cursor.
...
Explore example prompts in our [Examples documentation](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/EXAMPLES.md).

For best practices and tips to enhance your experience with the MCP Server, refer to the [How-To guide](https://github.com/microsoft/azure-devops-mcp/blob/main/docs/HOWTO.md).
...
> ⚠️ Please read the [Contributions Guide](https://github.com/microsoft/azure-devops-mcp/blob/main/CONTRIBUTING.md) before creating a pull request.
