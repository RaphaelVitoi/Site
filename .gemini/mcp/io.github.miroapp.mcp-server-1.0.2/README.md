...
See [Claude Code Plugins](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/overview.md) for full documentation.
...
See [Gemini CLI Extension](https://github.com/miroapp/miro-ai/blob/main/docs/gemini-cli/overview.md) | [Official Docs](https://geminicli.com/docs/extensions/)
...
For local development, see [CONTRIBUTING.md](https://github.com/miroapp/miro-ai/blob/main/CONTRIBUTING.md#kiro-powers).

See [Kiro Powers](https://github.com/miroapp/miro-ai/blob/main/docs/kiro/overview.md) | [Official Docs](https://kiro.dev/docs/powers/installation/)
...
See [Agent Skills Overview](https://github.com/miroapp/miro-ai/blob/main/docs/agent-skills/overview.md) | [agentskills.io](https://agentskills.io)
...
See [MCP Setup Guide](https://github.com/miroapp/miro-ai/blob/main/docs/getting-started/mcp-setup.md) for client-specific paths.
...
Want to modify plugins, test changes locally, or build your own? See [CONTRIBUTING.md](https://github.com/miroapp/miro-ai/blob/main/CONTRIBUTING.md#local-development-setup) for dev setup instructions.
...
>
> See [Enterprise Guide](https://github.com/miroapp/miro-ai/blob/main/docs/getting-started/enterprise.md) for setup instructions.
...
| Plugin | Description |
|--------|-------------|
| [miro](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/miro.md) | Core MCP integration with 5 commands |
| [miro-tasks](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/miro-tasks.md) | Automatic task tracking in Miro tables |
| [miro-solutions](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/miro-solutions.md) | Create customer demo plugins |
| [miro-research](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/miro-research.md) | Research and visualize findings on Miro |
...
| Power | Description |
|-------|-------------|
| [code-gen](https://github.com/miroapp/miro-ai/blob/main/docs/kiro/code-gen.md) | Design-to-code workflows |
...
### Getting Started
- [MCP Setup Guide](https://github.com/miroapp/miro-ai/blob/main/docs/getting-started/mcp-setup.md) — Client-specific configuration
- [Enterprise Guide](https://github.com/miroapp/miro-ai/blob/main/docs/getting-started/enterprise.md) — Admin setup for enterprise

### Platform Guides
- [Claude Code Plugins](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/overview.md)
- [Gemini CLI Extension](https://github.com/miroapp/miro-ai/blob/main/docs/gemini-cli/overview.md)
- [Cursor Plugins](https://github.com/miroapp/miro-ai/blob/main/docs/cursor/overview.md)
- [Agent Skills](https://github.com/miroapp/miro-ai/blob/main/docs/agent-skills/overview.md)
- [Kiro Powers](https://github.com/miroapp/miro-ai/blob/main/docs/kiro/overview.md)

### Reference
- [MCP Tools Reference](https://github.com/miroapp/miro-ai/blob/main/docs/mcp/tools-reference.md)
- [MCP Tutorials](https://github.com/miroapp/miro-ai/blob/main/docs/mcp/tutorials.md)
- [Troubleshooting](https://github.com/miroapp/miro-ai/blob/main/docs/troubleshooting.md)

### Development
- [Plugin Development Guide](https://github.com/miroapp/miro-ai/blob/main/docs/claude-code/plugin-development.md)
- [Power Development Guide](https://github.com/miroapp/miro-ai/blob/main/docs/kiro/power-development.md)
- [Validation](https://github.com/miroapp/miro-ai/blob/main/docs/validation/README.md)
- [Contributing](https://github.com/miroapp/miro-ai/blob/main/CONTRIBUTING.md)
...
MIT — see [LICENSE](https://github.com/miroapp/miro-ai/blob/main/LICENSE)
