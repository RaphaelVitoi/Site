...
* [`@stripe/agent-toolkit`](https://github.com/stripe/agent-toolkit/blob/main/tools/typescript) - for integrating Stripe APIs with popular agent frameworks through function calling—available in [Python](https://github.com/stripe/agent-toolkit/blob/main/tools/python) and [TypeScript](https://github.com/stripe/agent-toolkit/blob/main/tools/typescript).
* [`@stripe/ai-sdk`](https://github.com/stripe/agent-toolkit/blob/main/llm/ai-sdk) - for integrating Stripe's billing infrastructure with Vercel's [`ai`](https://npm.im/ai) and [`@ai-sdk`](https://ai-sdk.dev/) libraries.
* [`@stripe/token-meter`](https://github.com/stripe/agent-toolkit/blob/main/llm/token-meter) - for integrating Stripe's billing infrastructure with native SDKs from OpenAI, Anthropic, and Google Gemini, without any framework dependencies.
...
See [MCP](https://github.com/stripe/agent-toolkit/blob/main/tools/modelcontextprotocol) for more details.
...
Included below are basic instructions, but refer to [Python](https://github.com/stripe/agent-toolkit/blob/main/tools/python) and [TypeScript](https://github.com/stripe/agent-toolkit/blob/main/tools/typescript) packages for more information.
...
Examples for OpenAI's Agent SDK,LangChain, and CrewAI are included in [/examples](https://github.com/stripe/agent-toolkit/blob/main/tools/python/examples).
...
If you're upgrading from v0.8.x, see the [Migration Guide](https://github.com/stripe/agent-toolkit/blob/main/tools/typescript/MIGRATION.md) for breaking changes.
...
[MIT](https://github.com/stripe/agent-toolkit/blob/main/LICENSE)