...
> Consulte [`.claude/INSTRUCTION_HIERARCHY.md`](.claude/INSTRUCTION_HIERARCHY.md) para entender como este documento se relaciona com `.claude/CLAUDE.md` (user-level) e `.claude/agents/*.md` (agent-specific). Este é o arquivo PROJECT-LEVEL (Camada 2 de 3).
>
...
>
> Última sincronização: 2026-03-12 | Consolidado | Removida duplicação em `.claude/GLOBAL_INSTRUCTIONS.md`
...
6. **Segurança Proativa:** Identificar riscos em tecnologias obsoletas (ex: Python 2) e priorizar a migração ou isolamento de componentes inseguros. Validar todos os inputs e evitar exposição de segredos.
