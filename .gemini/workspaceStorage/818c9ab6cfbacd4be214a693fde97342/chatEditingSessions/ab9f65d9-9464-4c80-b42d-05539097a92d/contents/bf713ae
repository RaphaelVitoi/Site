...
**Acionado quando:** O usuário ou o projeto estão estagnados, presos em clichês, ou precisam de um parceiro de debate intelectualmente agressivo. Pode ser rodado ANTES do @dispatcher (para gerar ideias) ou DURANTE qualquer fase para desbloqueio criativo.
...
**Output:** "Relatório de Disrupção" com conexões laterais e propostas divergentes.
