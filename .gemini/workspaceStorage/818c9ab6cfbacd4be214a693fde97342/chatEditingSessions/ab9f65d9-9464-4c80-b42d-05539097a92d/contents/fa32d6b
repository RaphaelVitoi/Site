...
5. Adicionar validação JSON em PowerShell scripts
6. Documentar troubleshooting em MANUAL

### **Médio Prazo (3-5 horas):**
7. Refatorar project-context vs. MANUAL para clareza de propósito
8. Normalizar schema de `queue/tasks.json` com versioning
9. Merge de agent-memory duplicação com project-context
