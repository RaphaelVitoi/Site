...
import {
  startCommand,
  startServer
} from "./chunk-6RRFSIOS.js";
import {
  exitCli,
  require_source
} from "./chunk-V2UEKOLZ.js";
import {
  DEFAULT_PORT,
  GEMMA_MODEL_NAME,
  ...
  resolveGemmaConfig,
  saveModelChange
} from "./chunk-WAF66ETY.js";
import {
  RELAUNCH_EXIT_CODE
} from "./chunk-RGAYVX4S.js";
import "./chunk-SDWYIA3P.js";
import {
  cleanupCheckpoints,
  registerCleanup,
  registerSyncCleanup,
...
async function runNonInteractive({
  ...
  return promptIdContext.run(prompt_id, async () => {
    ...
    if (process.env["GEMINI_CLI_ACTIVITY_LOG_TARGET"]) {
      const { setupInitialActivityLogger } = await import("./devtoolsService-GPVBU4MX.js");
...
async function startInteractiveUI(config, settings, startupWarnings, workspaceRoot = process.cwd(), resumedSessionData, initializationResult) {
  const { startInteractiveUI: doStartUI } = await import("./interactiveCli-24M2ZUDS.js");
  await doStartUI(
    config,
    settings,
    startupWarnings,
...
${finalArgs[promptIndex + 1]}`;
  ...
  }
  {
    ...
    initAppHandle?.end();
    import("./liteRtServerManager-WDPDEOBK.js").then(({ LiteRtServerManager }) => {
