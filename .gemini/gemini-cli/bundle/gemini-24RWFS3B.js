...
import {
  startCommand,
  startServer
} from "./chunk-P3C3L47H.js";
import {
  exitCli,
  require_source
} from "./chunk-WMZHAGQZ.js";
import {
  DEFAULT_PORT,
  GEMMA_MODEL_NAME,
  ...
  resolveGemmaConfig,
  saveModelChange
} from "./chunk-BTZ4PDKV.js";
import {
  RELAUNCH_EXIT_CODE
} from "./chunk-75ACDDAC.js";
import "./chunk-Z6PP66GG.js";
import {
  cleanupCheckpoints,
  registerCleanup,
  registerSyncCleanup,
...
async function runNonInteractive({
  ...
  return promptIdContext.run(prompt_id, async () => {
    ...
    if (process.env["GEMINI_CLI_ACTIVITY_LOG_TARGET"]) {
      const { setupInitialActivityLogger } = await import("./devtoolsService-RJL4PC24.js");
...
async function startInteractiveUI(config, settings, startupWarnings, workspaceRoot = process.cwd(), resumedSessionData, initializationResult) {
  const { startInteractiveUI: doStartUI } = await import("./interactiveCli-PVAZLQ4B.js");
  await doStartUI(
    config,
    settings,
    startupWarnings,
...
${finalArgs[promptIndex + 1]}`;
  ...
  }
  {
    ...
    initAppHandle?.end();
    import("./liteRtServerManager-BHNCNQSQ.js").then(({ LiteRtServerManager }) => {
