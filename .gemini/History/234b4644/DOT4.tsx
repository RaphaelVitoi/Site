  ...
  return (
    <main className="container max-w-3xl mx-auto px-4" style={{ padding: '4rem 0' }}>
      ...
      <article className="animate-fade-up">
        ...
        {/* Renderização rica de conteúdo (Herda do globals.css) */}
        <div 
          className="sales-article mt-8"
          dangerouslySetInnerHTML={{ __html: post.content || post.body || '<p>A entropia corrompeu este registro. Conteúdo em formatação...</p>' }}
        />
      </article>
    </main>
  );
