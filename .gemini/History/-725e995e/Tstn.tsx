    ...
    return (
        <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body pb-24">
            ...
            <div className="sota-container -mt-12 relative z-10 space-y-16">
                ...
                <section className="max-w-6xl mx-auto mt-16" aria-label="Simulador Dinâmico de Downward Drift">
                    {/* Injeção SOTA: Materializa a teoria matemática em laboratório interativo */}
                ...
                <section className="max-w-6xl mx-auto">
                    ...
                    {/* SOTA: Injeção de Estado Termodinâmico Inicial */}
                    <GtoCfrContent initialState={{ currentPot: 10, targetPot: 100, streets: 3, fold: 50, call: 100, raise: -20 }} />
                </section>
