...
export const metadata = {
  ...
  description: 'A Fenomenologia da Incerteza: Exegese crítica das heurísticas de ICM.',
};

export default function PsicologiaHSPage() {
  // Fallback posts para garantir que a página não dependa exclusivamente do banco nesta fase
  ...
  export default function PsicologiaHSIndex() {
    // O endpoint consumirá os fallbacks. Quando o Prisma estiver ativado, trocamos esta linha pela query.
      ...
      <main className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '4rem 1.5rem' }}>
        <header className="page-header" style={{ paddingBottom: '1rem' }}>
          <p className="page-label">
            ...
            <main className="container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
              <LessonHeader
                title="Psicologia High Stakes"
                category="Laboratório Clínico • Mental Game"
              />

              <div className="mt-4 mb-16 text-center max-w-3xl mx-auto animate-fade-up animation-delay-200">
                <p className="text-slate-400 text-lg leading-relaxed text-balance">
                  A Fenomenologia da Incerteza. Dissecando a mente sob pressão extrema de <strong>Risk Premium</strong> e as barreiras cognitivas que destroem o ROI nas retas finais.
                </p>
