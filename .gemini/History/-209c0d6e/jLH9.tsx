    ...
    <main className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <article className="animate-fade-up">
        <LessonHeader
          ...
          category="Protocolo de Análise Textual Complexa"
        />

        <div className="glass-panel p-6 md:p-10 lg:p-12 border border-white/10 shadow-2xl shadow-fuchsia-500/10 rounded-xl animate-fade-up animation-delay-200">
          <div className="prose prose-invert prose-fuchsia max-w-none">
            <h2 className="article-title" style={{ marginTop: 0 }}>A Fenomenologia da Incerteza e a Transubstanciação do Valor</h2>
            <p className="lead" style={{ textAlign: 'center', fontStyle: 'italic', opacity: 0.8, marginBottom: '3rem' }}>Uma Exegese Crítica das Heurísticas de ICM e da Arquitetura de Solvers em Ambientes de Informação Imperfeita</p>
        ...
        <section className="mt-20 pt-16 border-t border-white/10 animate-fade-up animation-delay-400">
          <div className="text-center mb-10">
            <h3 className="text-3xl font-bold font-heading text-white mb-4">Laboratório Clínico</h3>
            <p className="text-slate-400">Explore outros protocolos específicos de intervenção psicológica e mindset.</p>
          </div>
