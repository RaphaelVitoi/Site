      ...
      <div className="bg-bg-deep/80 backdrop-blur-md border border-white/10 rounded-3xl p-6 lg:p-8 shadow-2xl relative overflow-hidden group mt-4">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-b border-white/5 pb-5 mb-5 relative z-10 gap-4">
          <div className="flex items-center gap-3">
            ...
            <strong className="text-[0.75rem] font-black text-white uppercase tracking-[0.1em]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="bg-black/50 border border-white/5 rounded-xl p-4 flex flex-col justify-center gap-4 h-full shadow-inner">
              <div className="flex justify-between items-center">
                ...
                <span className={`text-[0.85rem] font-mono font-black ${isCalculatingWasm ? 'text-text-dim animate-pulse' : gpuWinRate !== null ? 'text-white' : 'text-text-darker'}`}>
                  {isCalculatingWasm ? 'WASM...' : gpuWinRate !== null ? `${gpuWinRate.toFixed(1)}%` : 'N/A'}
                </span>
              </div>
              <div className="w-full h-px bg-white/5" />
              <div className="flex justify-between items-center">
                <span className="text-[0.65rem] text-text-muted font-bold uppercase tracking-widest">A* Risk Infl.</span>
                <span className={`text-[0.85rem] font-mono font-black ${isCalculatingWasm ? 'text-text-dim animate-pulse' : gpuRiskIndex !== null ? 'text-accent-amber' : 'text-text-darker'}`}>
                  {isCalculatingWasm ? 'WASM...' : gpuRiskIndex !== null ? `${(gpuRiskIndex * 100).toFixed(1)}%` : 'N/A'}
                </span>
              </div>
            </div>
          </div>
