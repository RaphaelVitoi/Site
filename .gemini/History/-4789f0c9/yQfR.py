...
try:
    with open(Path(__file__).parent.parent.parent.parent / f"{slug}.md", "r", encoding="utf-8") as f:
        markdown_body = f.read()
except FileNotFoundError:
    print(f"[ERRO] O arquivo {slug}.md não foi encontrado na raiz do projeto. Execute o script de conversão primeiro.")
    exit(1)
