...
def build_matrix():
    ...
    with open(base / "data/intentmap.json", "r", encoding="utf-8-sig") as f:
        intents = json.load(f)
    with open(base / "data/routing_map.json", "r", encoding="utf-8-sig") as f:
        routes = json.load(f)
    with open(base / "data/system_config.json", "r", encoding="utf-8-sig") as f:
        sys_cfg = json.load(f)
