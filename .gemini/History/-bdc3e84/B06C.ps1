...
function nexus-commands {
    ...
    $CommandGroups = [ordered]@{
        ...
        "CONTROLE DE AUTONOMIA (GOD MODE)" = @(
            @{ Name = 'autonomy-full'; Desc = 'Ativa o God Mode irrestrito (Auto-execucao de comandos)' },
            @{ Name = 'autonomy-partial'; Desc = 'Autonomia com bloqueio de comandos destrutivos/alteradores' },
            @{ Name = 'autonomy-off'; Desc = 'Desativa execucao de terminal (Apenas forjamento de arquivos)' }
        )
    }
