...
async def call_gemma_local(
    ...
    model: str,  # NOSONAR - Preserva contrato da interface
    model: str,  # pylint: disable=unused-argument
    system_prompt: str,
    user_prompt: str,
    key: str,  # Dummy key
    timeout: aiohttp.ClientTimeout | None = None,  # NOSONAR
    require_json: bool = False,  # NOSONAR
    key: str,  # pylint: disable=unused-argument
    timeout: aiohttp.ClientTimeout | None = None,
    require_json: bool = False,  # pylint: disable=unused-argument
    **kwargs: Any,
    ...
    try:
        ...
        logger.exception(f"[GEMMA-LOCAL] Erro na inferencia: {e}")
