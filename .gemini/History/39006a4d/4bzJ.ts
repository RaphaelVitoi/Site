...
export async function POST ( req: Request )
{
    try
    {
        ...
        const body = JSON.parse( bodyText ) as Partial<ProxyPayload>;
        ...
        {
            return await handleByokCustom( body as ProxyPayload );
        }

        return await handlePokerRacionalCloud( body as ProxyPayload );
