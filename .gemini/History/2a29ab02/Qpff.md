...
> **2.** Inicie o seu trabalho rodando a elaboração do PRD/SPEC para a feature "Cenários de Fundador" (`ICM-FEAT-FOUNDERS`), projetando a arquitetura necessária para alternar dinamicamente os Cap Tables e gráficos na UI do Simulador ICM.
