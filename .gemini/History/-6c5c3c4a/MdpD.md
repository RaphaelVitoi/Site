...
- [ ] **Promessas Next 16 / React 19:** O uso de APIs assincronas (como `params` ou `searchParams`) em Server Components esta adequadamente resolvido com `await` (exigencia SOTA)?
