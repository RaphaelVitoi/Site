...
if (Test-Path ".\.venv\Scripts\python.exe") {
    # SOTA: Lista unificada de dependencias para garantir a simetria do ecossistema.
    $dependencies = "pip", "google-genai", "pydantic", "rich", "psutil", "watchdog", "aiohttp", "aiosqlite"
    & .\.venv\Scripts\python.exe -m pip install --upgrade --force-reinstall $dependencies
    Write-Host "  > Malha Cognitiva (Python) elevada ao Estado da Arte." -ForegroundColor Green
}
