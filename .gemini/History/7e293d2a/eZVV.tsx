...
export default function ICMCalculator() {
  ...
  return (
    <div className="glass-panel p-6 sm:p-10 w-full max-w-4xl mx-auto mt-8 animate-fade-up">
      <div className="bg-slate-900/60 backdrop-blur-lg border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)] rounded-2xl p-6 sm:p-10 w-full max-w-4xl mx-auto mt-8 animate-fade-up">

        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold font-heading text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-sky-300 drop-shadow-[0_0_15px_rgba(34,211,238,0.4)] mb-2">Motor ICM de Alta Precisão</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-3">
                <h3 className="font-heading font-semibold text-cyan-400 uppercase tracking-widest text-xs">Stacks (Fichas)</h3>
              ...
              <div className="space-y-3">
                {players.map((p) => (
                  <div key={p.id} className="flex flex-col gap-3 bg-slate-900/50 p-3 rounded border border-white/5 transition-all hover:border-white/10 hover:bg-slate-800/50">
                    <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        className="bg-slate-950/80 border border-slate-800 text-slate-300 text-sm p-2 rounded w-1/2 text-right data-mono focus:border-cyan-400 focus:outline-none transition-colors shadow-inner"
                      />
                    </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-3">
                <h3 className="font-heading font-semibold text-emerald-400 uppercase tracking-widest text-xs">Payouts ($/%)</h3>
                ...
                {prizes.map((prize, idx) => (
                  <div key={idx} className="flex items-center gap-3 bg-slate-900/50 p-3 rounded border border-white/5">
                    ...
                    <input
                      ...
                      className="bg-slate-950/80 border border-slate-800 text-slate-300 text-sm p-2 rounded w-1/2 text-right data-mono focus:border-emerald-400 focus:outline-none transition-colors shadow-inner"
                    />
                  </div>
                ))}
              </div>
                  ...
                  <div key={res.id} className="relative">
                    <div className="flex justify-between items-end mb-1">
                      ...
                      <div className="text-right">
                        ...
                        <span className="text-xs text-sky-400 font-semibold data-mono">
                    ...
                    <div className="w-full bg-slate-950 rounded-full h-1.5 overflow-hidden">
                      <div
                        className="bg-gradient-to-r from-cyan-400 to-sky-400 h-1.5 rounded-full transition-all duration-500 ease-out shadow-[0_0_10px_rgba(56,189,248,0.8)]"
