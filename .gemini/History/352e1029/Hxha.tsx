...
import { fetchVisceralScenarios } from '../../app/actions/quizActions';
...
const FALLBACK_SCENARIOS: Scenario[] = [
    {
        ...
        context: 'Mesa Final (7 left). UTG (CL, 65bb) abre 2x. Você está no BB com 15bb. O pote tem 4.5bb. Você segura 97s.',
    ...
    useEffect( () => {
        ...
        fetchVisceralScenarios()
            .then( ( data ) => {
                ...
                else setScenarios( FALLBACK_SCENARIOS );
            } )
            .catch( ( error ) => {
                console.error( '[CORTEX SHIELD] Falha ao sincronizar Módulo Visceral. Injetando heurísticas locais.', error );
