...
const QUIZ_SCENARIOS: Scenario[] = [
    {
        ...
        choices: [
            ...
            },
            {
                ...
                metricImpact: { chipEv: '-1.00bb', icmEv: '-0.8% (Custo Fixo)', perspective: '+0.5% (Preservação)' }
            },
            {
                id: 'squeeze',
    ...
    },
    {
        ...
        choices: [
            ...
            },
            {
                ...
                metricImpact: { chipEv: '-1.00bb', icmEv: '-0.5% (Desconto RP)', perspective: '+2.1% (Manutenção de Pressão)' }
            }
        ]
    },
    {
        ...
        choices: [
            ...
            },
            {
                ...
                metricImpact: { chipEv: '-20.00bb', icmEv: '-18.0% (Dor Fixa)', perspective: '+0.0% (Sobrevivência Pura)' }
            }
        ]
    }
];
