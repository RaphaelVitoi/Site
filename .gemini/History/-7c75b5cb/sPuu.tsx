        ...
        <div style={{ minHeight: '100vh', background: '#020617', color: '#e2e8f0', overflowX: 'hidden' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                    <div>
                        ...
                        <p style={{ margin: '0.5rem 0 0', fontSize: '0.75rem', color: '#94a3b8', lineHeight: 1.6, maxWidth: '580px' }}>
                            Decisões Pós-Flop em Final Tables e a Nova Fronteira do Edge. Documento Técnico v1.0.
                        </p>
            ...
            <div id="modulo-1">
                <SectionHeader
                    ...
                    description="ChipEV vs ICM, Risk Premium, Antevisão e Valuations de Stack."
                />
            ...
            <div id="modulo-2">
                <SectionHeader
                    ...
                    description="5 cenários progressivos de RP 0→24%, do ChipEV puro ao Teto do RP."
                />
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem 3rem' }}>
                    <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
                        <div className="prose prose-invert prose-lg max-w-none text-slate-300">
                            ...
                            <div style={{ textAlign: 'center', margin: '3rem 0' }}>
                                <Link href="/aulas/icm-masterclass" className="btn-primary">
            ...
            <div id="parte-ii">
                <SectionHeader
                    step="03"
                    label="Paradoxo"
                    title="Invertendo o RP"
                    description="O que acontece quando o IP carrega RP maior que o OOP."
                />
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem 3rem' }}>
                    <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
                        <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <div id="modulo-3">
                <SectionHeader
                    ...
                    label="Fronteira"
                    title="ICM Pós-Flop"
                    description="Downward Drift, Dissipação de RP por street e dinâmica do Chip Leader."
                />
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem 3rem' }}>
                    <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
                        <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <div id="modulo-4">
                <SectionHeader
                    ...
                    description="10 erros mais comuns e Checklist de decisão em tempo real."
                />
                <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem 3rem' }}>
                    <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
                        <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem 3rem' }}>
                <nav className="article-nav">
                    <Link href="/aulas/icm-masterclass"><i className="fa-solid fa-arrow-left" style={{ marginRight: '4px' }} /> Voltar para a Aula</Link>
                    <Link href="/aulas/conceitos-icm">Glossário Formal <i className="fa-solid fa-arrow-right" style={{ marginLeft: '4px' }} /></Link>
                </nav>
            </div>
        </div>
    );
