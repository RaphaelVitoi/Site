...
export interface RiskGaugeProps {
  ...
  stackTooltip?: string;
  threshold?: number;
  dynamicDeathZone?: number | undefined; // SOTA: Horizonte dinâmico vindo do motor quântico
...
export default function RiskGauge( {
  ...
  const { startColor, endColor, strokeColor, glowColor } = getGaugeColors(isDeathZone, isPredatorZone, isCritical, rpDiff);
