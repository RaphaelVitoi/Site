        ...
        <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
          ...
          <motion.path
            ...
            animate={{
                ...
                opacity: 1,
                filter: isDeathZone
                    ? [`drop-shadow(0 0 10px ${startColor})`, `drop-shadow(0 0 25px ${endColor})`, `drop-shadow(0 0 10px ${startColor})`]
                    : isPredatorZone
                    ? [`drop-shadow(0 0 8px ${startColor}80)`, `drop-shadow(0 0 15px ${endColor})`, `drop-shadow(0 0 8px ${startColor}80)`]
                    : `drop-shadow(0 0 8px ${startColor}80)`
            }}
            transition={{
