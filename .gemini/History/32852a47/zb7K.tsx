...
import { SectionHeader } from "../frontend/src/components/ui/SectionHeader";
import { SotaMarkdown } from "../frontend/src/components/ui/SotaMarkdown";
'use client';
...
export default async function ContentPage({ params }: Readonly<{ params: { slug: string } }>) {
