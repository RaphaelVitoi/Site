    ...
    <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body">
      ...
      <section id="hero" className="relative pt-40 pb-24 px-6 overflow-hidden">
        <div className="sota-container relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto animate-sota-in">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button href="#metodo" size="lg" variant="primary" className="text-lg rounded-2xl tracking-tighter shadow-xl shadow-indigo-900/40" rightIcon={ <i className="fa-solid fa-arrow-right" /> }>
              EXPLORAR O NEXUS
            </Button>
            <Button href="/artigos/estado-da-arte" size="lg" variant="ghost" className="text-lg rounded-2xl tracking-tighter border border-white/10 hover:bg-white/5 backdrop-blur-md">
              WHITEPAPER
            </Button>
          </div>
        </div>
      ...
      <div className="sota-container pb-32 mt-12">
        <div className="bg-linear-to-br from-bg-elevated/60 to-bg-base p-12 rounded-3xl border border-accent-indigo/20 text-center relative overflow-hidden group">
          ...
          <Button href="/blog" size="lg" variant="primary" className="pulse-glow text-lg rounded-2xl" rightIcon={ <i className="fa-solid fa-brain" /> }>
            ACESSAR O CÓRTEX
          </Button>
        </div>
      </div>
