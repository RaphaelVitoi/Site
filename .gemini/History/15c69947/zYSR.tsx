...
export default function HomePage() {
  return (
    <div style={{ minHeight: '100vh', background: '#020617', color: '#e2e8f0', overflowX: 'hidden' }}>
      ...
      {/* Hero Section */}
      <section id="hero" className="animate-fade-up" style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto', padding: '6rem 1.5rem' }}>
        <div className="page-label" style={{ color: 'var(--accent-primary)', marginBottom: '1.5rem', display: 'inline-block', background: 'rgba(99, 102, 241, 0.1)', border: '1px solid rgba(99, 102, 241, 0.2)', padding: '0.3rem 0.9rem', borderRadius: '99px', fontSize: '0.8rem' }}>
        ...
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              ...
              <li style={{ marginBottom: '0.8rem' }}><strong>2. Conceitos próprios nomeados:</strong> Teto do RP, RP de ida vs volta — nomenclatura clara que o mercado não usa.</li>
              <li style={{ marginBottom: '0.8rem' }}><strong>3. ICM pós-flop como tese central:</strong> a maioria do conteúdo existente trata ICM como fenômeno pré-flop.</li>
              <li style={{ marginBottom: '0.8rem' }}><strong>4. Crítica fundamentada aos solvers:</strong> solvers como mapa, não como território — posição que diferencia o conteúdo de tutoriais.</li>
      ...
      />
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem 3rem' }}>
        <div className="author-section" style={{ background: 'var(--bg-card)', borderRadius: 'var(--radius-xl)', padding: '2rem', border: 'var(--glass-border)', backdropFilter: 'blur(12px)' }}>
          <div className="video-wrapper-inline" style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden' }}>
            <video autoPlay muted playsInline loop preload="metadata" style={{ aspectRatio: '9/16', objectFit: 'cover', width: '100%', height: '100%' }}>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <div style={{ marginTop: '2rem', display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
              ...
              <Link href="/" className="badge-link badge-link-secondary">Fundador Poker Racional</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* CTA Final */}
      <div style={{ background: 'radial-gradient(ellipse at top, rgba(99, 102, 241, 0.15), transparent 60%)' }}>
        <section id="final-cta" style={{ textAlign: 'center', padding: '6rem 1.5rem' }}>
          <p style={{ fontSize: '1.5rem', fontStyle: 'italic', marginBottom: '2rem', color: 'var(--text-main)', maxWidth: '700px', margin: '0 auto 2rem' }}>
            &quot;O edge não está mais nas cartas que você recebe, mas na precisão com que você avalia o risco de jogá-las.&quot;
          </p>
          <h2 style={{ fontSize: '2.5rem', margin: '0 auto 3rem', maxWidth: '700px' }}>Recupere seu ROI. Domine a fronteira final.</h2>
