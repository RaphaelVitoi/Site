...
export default function HomePage() {
  return (
    <main className="container pt-16">
      ...
      {/* Hero Section */}
      <section id="hero" className="animate-fade-up text-center max-w-4xl mx-auto">
        <p className="page-label text-accent-primary mb-6">
          ICM e Risk Premium Pós-Flop
        </p>
        <h2 className="text-[clamp(2rem,5vw,3rem)] leading-tight">
          O Edge Mudou de Lugar
          <span className="block font-light text-text-main mt-2">
            Você Ainda Está Jogando o Jogo de 2020?
          </span>
        </h2>
        <p className="page-subtitle text-xl mx-auto mb-10">
        ...
        <div className="flex gap-4 justify-center mt-8 flex-wrap">
          <Link href="#metodo" className="btn-primary px-10 py-4 text-sm">
            Conhecer o Método <i className="fa-solid fa-arrow-right" style={{ marginLeft: '6px' }} />
          </Link>
          <Link href="/aulas/leitura-icm" className="btn-secondary px-10 py-4 text-sm">
            Ler o Whitepaper
          </Link>
        </div>
      </section>
