...
def _flush_telemetry_buffer() -> None:
    with _TELEMETRY_LOCK:
        ...
        try:
            ...
            logger.error(f"[SOTA TELEMETRY] Falha catastrófica ao persistir telemetria: {e}")
            logger.exception(f"[SOTA TELEMETRY] Falha catastrófica ao persistir telemetria: {e}")
