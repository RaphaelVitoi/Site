...
class SOTALogger {
  ...
  private async flush () {
    ...
    } catch ( err )
    {
      ...
      {
        // Falha silenciosa para evitar loops de erro, mas reinserimos na fila para tentar depois em prod
        console.warn( '[SOTA Logger] Falha ao enviar logs para o servidor:', err );
        this.queue.unshift( ...events );
      }
      // Em desenvolvimento (dev), a falha é sumariamente engolida e a fila é descartada. Fricção zero.
    } finally
    {
