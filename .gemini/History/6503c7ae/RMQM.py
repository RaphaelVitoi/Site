...
AGENTS_MANIFEST = load_json_config(BASE_DIR / "data/agents_manifest.json", {})
if AGENTS_MANIFEST:
...
if not VALID_AGENTS:
    logging.critical(f"CRITICAL: {AGENT_SOURCE} nao encontrado ou vazio. O sistema nao tem consciencia de seus agentes.")
    sys.exit(1)
...
# Este arquivo foi identificado como codigo orfao e sua logica foi consolidada no task_executor.py.
# Ele e mantido em branco para evitar quebras de importacao em modulos nao auditados
# e pode ser removido com seguranca em uma proxima fase de limpeza.
