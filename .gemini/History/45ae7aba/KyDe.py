...
def _handle_provider_error(error_msg: str, provider_name: str, provider_key: str, block_on_429: bool) -> bool:
    """Retorna True se deve abortar o loop desta chave, False para prosseguir silenciosamente."""
