...
export const QuizResults: React.FC<QuizResultsProps> = ( { score, total, onRestart } ) =>
{
    ...
    const colorVar = isSuccess ? 'var(--accent-emerald)' : 'var(--accent-danger)';
    ...
    return (
        <div className="py-16 px-8 text-center animate-sota-in">
            ...
            <p className="text-text-muted text-[0.95rem] max-w-[400px] mx-auto mb-8 leading-relaxed">
                O seu modelo cognitivo foi testado contra a topologia deste cenário.
            </p>

            <div className={ `inline-flex flex-col items-center justify-center w-[180px] h-[180px] rounded-full mb-10 border-2 ${ isSuccess ? 'border-accent-emerald/30 shadow-[0_0_30px_rgba(16,185,129,0.15)] bg-[radial-gradient(circle,rgba(15,23,42,1)_50%,rgba(16,185,129,0.1)_100%)]' : 'border-accent-danger/30 shadow-[0_0_30px_rgba(244,63,94,0.15)] bg-[radial-gradient(circle,rgba(15,23,42,1)_50%,rgba(244,63,94,0.1)_100%)]' }` }>
