        ...
        <div className="flex flex-col gap-10">
            ...
            <div className="relative max-w-lg w-full mx-auto animate-fade-up">
                ...
                <input
                    ...
                    className="w-full bg-slate-900/60 backdrop-blur-md border border-white/10 text-white rounded-xl pl-11 pr-12 py-3.5 focus:outline-none focus:border-white/30 transition-all placeholder:text-slate-500 font-body shadow-inner"
                />
                {searchTerm && (
                    <button
