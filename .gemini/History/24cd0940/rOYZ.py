...
def build_likelihood_matrix(
    ...
    heuristics = {
        "top_pair_plus": {"bet": 0.75, "check": 0.25, "raise": 0.60, "fold": 0.05, "call": 0.80},
        "overpair": {"bet": 0.85, "check": 0.15, "raise": 0.75, "fold": 0.02, "call": 0.90},
        "mid_bottom_pair": {"bet": 0.30, "check": 0.70, "raise": 0.10, "fold": 0.65, "call": 0.50},
        "weak_pocket_pair": {"bet": 0.20, "check": 0.80, "raise": 0.05, "fold": 0.85, "call": 0.30},
        "air_or_draw": {"bet": 0.35, "check": 0.65, "raise": 0.25, "fold": 0.95, "call": 0.20},
    }
