...
if ($DailyReport) {
    ...
    # Roteamento de destino dinâmico (Fallback para docs/reports local se a variável não estiver definida)
    $ReportDir = if ($env:GOOGLE_DRIVE_REPORT_PATH) { $env:GOOGLE_DRIVE_REPORT_PATH -replace '\\', '/' } else { 'docs/reports' }
