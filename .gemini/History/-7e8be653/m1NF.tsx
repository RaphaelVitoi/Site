                    ...
                    <div className="flex items-center gap-3 mb-4">
                        { isUserCorrect ? (
                            <>
                                ...
                                <h3 className="text-accent-emerald uppercase tracking-widest text-[0.85rem] font-black m-0">
                            ...
                            <>
                                ...
                                <h3 className="text-accent-danger uppercase tracking-widest text-[0.85rem] font-black m-0">
                                    Entropia Detectada
                                </h3>
                            </>
                        ) }
