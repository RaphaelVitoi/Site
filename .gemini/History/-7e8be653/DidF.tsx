...
export const QuizQuestion: React.FC<QuizQuestionProps> = ( { question, selectedOptionId, onSelectOption } ) =>
{
    ...
    const handleAskOracle = async () =>
    {
        ...
        {
            console.warn( "[Oráculo] Mente Coletiva (17042) offline. Comutando para Fallback local..." );
            ...
            {
                console.warn( "[Oráculo Local] Motores locais (Browser AI / Ollama) indisponíveis." );
            }
