...
## 7. Framework de Checklist Operacional (SENTINEL-v1)

_Este framework é uma restrição sistêmica obrigatória para as camadas de planejamento e execução._

**Camada @planner (Intenção):**

- [ ] **Axioma Bayesiano:** Substituir incertezas ("se possível") por condições lógicas exatas.
- [ ] **Entropia Zero:** Extirpar funcionalidades cosméticas sem propósito estratégico claro.
- [ ] **Design de Incentivos:** Aplicar ganchos de Teoria dos Jogos e feedback imediato.
- [ ] **Honestidade Radical:** Admitir limitações técnicas e trade-offs (ex: latência vs. portabilidade).
- [ ] **Estética Semiótica:** Usar terminologia da Cosmovisão (Operador/Player, Falha de Integridade).

**Camada @implementor (Realidade):**

- [ ] **Blindagem Estética:** Respeitar a estética Dark-Cyber (caracteres █, ░, ─).
- [ ] **Atomicidade SQLite:** Transações tratadas como mãos de poker (Commit ou Rollback).
- [ ] **Otimização GTO:** Implementar a solução mais eficiente matematicamente, não a mais fácil.
- [ ] **Verdade Nua:** Documentar dívida técnica e rationale nos comentários (HACK/TODO).
- [ ] **Simetria Operacional:** Scripts devem fornecer diagnósticos acionáveis em caso de falha.
