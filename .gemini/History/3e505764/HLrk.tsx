          ...
          <div className="prose prose-invert prose-lg max-w-none text-text-muted">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-16">
              { [
                ...
                <a key={ p.title } href={ p.link } target="_blank" rel="noopener" className="p-6 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-accent-indigo/30 hover:bg-white/[0.05] transition-all text-center group">
