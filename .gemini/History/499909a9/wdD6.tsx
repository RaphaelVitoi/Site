...
export function SotaHubNavbar() {
    ...
    return (
        <div className="sticky top-20 z-40 w-full bg-black/60 backdrop-blur-md border-b border-white/10 shadow-lg">
            <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <nav className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-hide">
                    <Link
                        href="/simulador"
                        className={ `px-4 py-1.5 rounded-full text-sm font-bold transition-all whitespace-nowrap ${isActive( '/simulador' ) ? 'bg-accent-indigo text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'}` }
                    >
                    ...
                    <Link
                        ...
                        className={ `px-4 py-1.5 rounded-full text-sm font-bold transition-all whitespace-nowrap ${isActive( '/simulador/gto-cfr' ) ? 'bg-accent-indigo text-white' : 'text-zinc-400 hover:text-white hover:bg-white/5'}` }
                    >
