      ...
      {allTags.length > 0 && (
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-xs font-mono uppercase tracking-widest transition-all border ${!selectedTag ? 'bg-fuchsia-500/20 border-fuchsia-400 text-fuchsia-300 shadow-[0_0_15px_-3px_rgba(217,70,239,0.4)]' : 'bg-slate-900/50 border-white/10 text-slate-400 hover:text-white hover:border-white/30'}`}
          >
            Todos
          </button>
          {allTags.map(tag => (
