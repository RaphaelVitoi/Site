            ...
            <div className="h-full space-y-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-3 mb-4 p-3 sm:p-4 rounded-xl bg-slate-900/50 border border-white/5 shadow-inner">
                <div className="flex items-center gap-3">
                  ...
                  <label id="rp-toggle-label" className="text-xs font-bold text-fuchsia-400 uppercase tracking-wider cursor-pointer">
                ...
                <button
                  ...
                  className={ `${isDynamicRpActive ? 'bg-fuchsia-600' : 'bg-zinc-700'
                    } relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:ring-offset-2 focus:ring-offset-slate-900` }
                >
                  <span
                    aria-hidden="true"
