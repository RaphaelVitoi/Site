...
function calculateInsolvencyDelta ( rankValue: number, isSuited: boolean, isPair: boolean, rpFactor: number, pureEv: number, heroInvested: number, currentPot: number, activePlayers: number ): number {
...
function calculateFallbackCell ( i: number, j: number, rpFactor: number, ranks: string[], heroInvested: number, currentPot: number, activePlayers: number ) {
  ...
  const insolvencyDelta = calculateInsolvencyDelta( rankValue, isSuited, isPair, rpFactor, pureEv, heroInvested, currentPot, activePlayers );
