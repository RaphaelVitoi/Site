    ...
    <div className="space-y-6">
      <div className="p-4 rounded-xl bg-slate-900/50 border border-white/5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <MetricTooltip title="Agressor (IP)" desc="O agressor dita o preço. Se o RP dele é significativamente menor, ele usa o Leverage para extrair Fold Equity não-linear da mesa.">
          ...
          <MetricTooltip title="Defensor (OOP)" desc="O defensor paga a conta do ICM. Ele precisa de uma mão exponencialmente mais forte para justificar o call, ancorando a defesa no Teto de Risco.">
            ...
            <div className="space-y-6">
              ...
              { context?.quantumPerspectiva && context?.spotData && context?.actionMetrics && (
                <DegradationChart
                  ...
                  potOddsPct={ ( context.spotData.pot / ( context.spotData.pot + Math.abs( context.actionMetrics.fold.chipEv ) ) ) * 100 || 33 }
                  potSizePct={ 10 } // Proxy de estimativa para RIO
                />
              ) }
            </div>
          ) }
