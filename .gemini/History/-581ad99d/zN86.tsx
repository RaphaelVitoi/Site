...
export const ActionTooltip = ( { title, desc, children }: { title: string, desc: string, children: React.ReactNode } ) => (
    <div className="relative group cursor-help flex-1 flex flex-col">
        { children }
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-[85vw] sm:w-64 p-3 bg-[#0a0f1c] border border-neutral-700/50 rounded-lg shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-[100] pointer-events-none">
