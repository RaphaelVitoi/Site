    ...
    return (
        <div className="min-h-screen bg-bg-base text-text-main pb-24">
            ...
            <div className="max-w-4xl mx-auto px-6">
                <GlassPanel className="p-8 md:p-12 prose prose-invert prose-lg max-w-none font-body">
                    ...
                    <div className="bg-bg-elevated border-l-4 border-accent-amber p-6 my-8 rounded-r-lg">
                        <h4 className="text-accent-amber font-bold text-lg mb-2">A Value Function (Curva de Utilidade)</h4>
...
if (n > 10) {
    return calculateIcmMonteCarlo(stacks, prizes, { iterations: 20000 });
                    ...
                    <div className="flex justify-center mt-12">
                        <Link href="/laboratorio-v2" className="btn-primary px-8 py-4 text-sm font-bold tracking-widest uppercase">
