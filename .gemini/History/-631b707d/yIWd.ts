...
// SOTA FIX: Declaração das constantes do WebGPU para selar o TypeScript (Fricção Zero)
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    // TODO: A injeção completa das tabelas de Hand Evaluation do Poker
    // deve ser alocada em um StorageBuffer separado (≈ 130MB).
    // Por enquanto, usamos a distribuição estocástica termodinâmica.
