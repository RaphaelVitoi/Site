...
globalThis.onmessage = async ( e: MessageEvent ) =>
{
    ...
    try
    {
        ...
        {
            // SOTA: Ponte de Memória Fricção Zero (Transferable Objects / Sem Overhead JSON)
            const bufferSize = payload.nodes * payload.nodes;
            const regretMatrix = new Float32Array(bufferSize);
