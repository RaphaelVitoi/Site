...
3. OBRIGACOES DO RELATORIO (DIRETRIZ C-LEVEL):
   ...
   - Hibrido: Avaliacao Quantitativa (latencia, I/O, RAM) e Qualitativa (resiliencia no cenario testado).
...
5. Salve o relatorio definitivo em `docs/reports/AUDIT_ONDEMAND_$(Get-Date -Format 'yyyyMMdd_HHmm').md` via God Mode.
6. Dispare o comando Toast do PowerShell para notificar o usuario que a auditoria SOTA foi concluida.
"@
