...
GEMINI_MODEL_KEY_BLOCK_DURATION = timedelta(minutes=int(os.environ.get("GEMINI_MODEL_KEY_BLOCK_MINUTES", "15")))
MAX_CALLS_PER_MINUTE = int(os.environ.get("MAX_CALLS_PER_MINUTE", "14")) # SOTA: Google Free Tier = 15 RPM por projeto
