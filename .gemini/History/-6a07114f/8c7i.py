# pylint: disable=missing-module-docstring, missing-class-docstring, missing-function-docstring, redefined-outer-name, protected-access
# ruff: noqa: S101
import asyncio
import importlib
...
from agents.context_builder import _inject_task_docs
...
def test_client_components_do_not_import_server_telemetry_module():
    ...
    assert "MetricPayloadSchema" in telemetry_route
