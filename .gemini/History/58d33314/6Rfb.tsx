          ...
          { players.map( ( p, idx ) => (
            <div key={ p.id } className={ styles.calcRow }>
              <button
                ...
                className="cursor-pointer text-[0.65rem] bg-transparent border-none p-0 transition-colors"
                style={{ color: heroId === p.id ? 'var(--accent-indigo)' : 'var(--bg-subtle)' }}
