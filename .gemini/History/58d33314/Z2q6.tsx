...
function InsolvencyRioPanel ( { insolvency, isCalculating }: { insolvency: any, isCalculating: boolean; } )
{
  ...
  const riskLevel = insolvency.riskIndex > 0.8 ? "Crítico" : insolvency.riskIndex > 0.4 ? "Moderado" : "Controlado";
  const riskColor = insolvency.riskIndex > 0.8 ? "text-accent-danger" : insolvency.riskIndex > 0.4 ? "text-accent-amber" : "text-accent-emerald";
