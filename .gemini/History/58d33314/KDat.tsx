      ...
      <div className={ styles.calcGrid2Col }>
        <div className={ styles.calcSection }>
          ...
          { players.map( ( p, idx ) => (
            <div key={ p.id } className={ styles.calcRow }>
              ...
              { players.length > 2 && ( <button onClick={ () => removePlayer( p.id ) } className={ styles.calcBtnRemove }>&times;</button> ) }
            </div>
          ) ) }
        ...
        <div className={ styles.calcSection }>
          ...
          <div className={ styles.calcBtnPrizeGroup }>
            ...
            { prizes.length > 1 && ( <button onClick={ removePrize } className={ styles.calcBtnPrizeRemove }>&minus;</button> ) }
          </div>
        </div>
      </div>
