    ...
    return (
        <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body pb-24">
            ...
            <SectionHeader
                ...
                title="Simulador de Downward Drift (CFR)"
                description="Neste cenário pré-configurado, o arrependimento por apostar grande (Raise) é fortemente negativo, forçando a estratégia a convergir para apostas menores (Call/Check) — a essência do Downward Drift."
            />
            <div className="max-w-300 mx-auto px-6 pb-12">
                <Suspense fallback={ <div className="p-12 text-center text-text-muted">Carregando Malha Geométrica...</div> }>
                    <GtoCfrContent initialState={ { currentPot: 10, targetPot: 25, streets: 3, fold: -5, call: 30, raise: -15 } } />
                </Suspense>
            </div>
