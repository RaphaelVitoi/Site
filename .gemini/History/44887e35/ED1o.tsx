                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input id="regretFold" type="number" value={ regrets.fold } onChange={ ( e ) => setRegrets( { ...regrets, fold: Number( e.target.value ) } ) } className="w-full bg-bg-deep border border-white/5 rounded-lg p-3 text-text-bright font-mono mt-2 focus:ring-1 focus:ring-accent-emerald outline-none" />
                                </div>
                                <div>
                                    <label htmlFor="regretCall" className="text-label text-text-muted">Arrependimento (Call)</label>
                                    <input id="regretCall" type="number" value={ regrets.call } onChange={ ( e ) => setRegrets( { ...regrets, call: Number( e.target.value ) } ) } className="w-full bg-bg-deep border border-white/5 rounded-lg p-3 text-text-bright font-mono mt-2 focus:ring-1 focus:ring-accent-emerald outline-none" />
                                </div>
                                <div>
                                    <label htmlFor="regretRaise" className="text-label text-text-muted">Arrependimento (Raise)</label>
                                    <input id="regretRaise" type="number" value={ regrets.raise } onChange={ ( e ) => setRegrets( { ...regrets, raise: Number( e.target.value ) } ) } className="w-full bg-bg-deep border border-white/5 rounded-lg p-3 text-text-bright font-mono mt-2 focus:ring-1 focus:ring-accent-emerald outline-none" />
                                </div>
                            </div>
