...
export default function TheoryPanel ( { scenario, effectiveSprData, effectiveStacks, effectiveIpRp = 0, effectiveOopRp = 0 }: Readonly<TheoryPanelProps> )
{
  ...
  return (
    <div className="glass-panel w-full p-8 lg:p-10 flex flex-col gap-8 animate-sota-in mt-6 bg-bg-panel/80 backdrop-blur-xl border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.6)] rounded-3xl relative overflow-hidden">
      ...
      <div className="relative z-10 w-full animate-sota-in" role="tabpanel">
        { activeTab === 'theory' && (
          <div className="flex flex-col gap-8 animate-sota-in w-full">
