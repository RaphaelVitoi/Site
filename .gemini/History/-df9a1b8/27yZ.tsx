    ...
    <div className="glass-panel p-8 flex flex-col gap-6 animate-sota-in">
      ...
      <div className="mt-2">
        ...
        { activeTab !== 'theory' && activeTab !== 'spr' && (
          <div className="p-12 text-center text-text-dim border border-dashed border-white/10 rounded-2xl bg-black/20 font-mono text-[0.65rem] font-black uppercase tracking-widest animate-sota-in">
