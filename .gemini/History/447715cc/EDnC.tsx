...
function InfoTooltip ( { text }: Readonly<{ text: string }> ) {
  ...
  return (
    <button
      ...
      style={ { display: 'inline-flex', alignItems: 'center', marginLeft: '3px', cursor: 'help', background: 'transparent', border: 'none', padding: 0 } }
  ...
  return (
    <div style={ {
      ...
      <div style={ { display: 'flex', alignItems: 'baseline', gap: '4px' } }>
        <span className={ styles.dataMono } style={ { fontSize: '0.9rem', fontWeight: 800, color: 'var(--text-main)' } }>
...
export default function NashPanel ( {
  ...
  return (
    <div className={ styles.glassPanel } style={ { padding: '1.25rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' } }>
      ...
      {/* Aggression Factor */ }
      <MetricTooltip title="Agressividade Humana (Fator Ψ)" desc="Modulador bayesiano SOTA. Se o oponente real desvia do equilíbrio (ex: paga demais ou blefa de menos), a distribuição de Nash é forçada a se contrair ou expandir.">
      ...
      {/* PKO Bounty */ }
      <MetricTooltip title="Bounty Power" desc="Diluidor de Risk Premium. A recompensa imediata (bounty) infla a utilidade do Call, destruindo o Teto de Risco do ICM tradicional.">
