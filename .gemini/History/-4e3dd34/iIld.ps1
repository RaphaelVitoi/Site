...
$statusLine = " 📊 Carga Atual  : {0} Pendentes | {1} Rodando" -f $pending, $running
...
Write-Host " 👁️  Visao e Monitoramento" -ForegroundColor Magenta
...
Write-Host "    ask `"pergunta`"      " -NoNewline -ForegroundColor Cyan; Write-Host "- Consulta a memoria coletiva (RAG) com o @bibliotecario." -ForegroundColor DarkGray
Write-Host " 🛠️  Controle Sistemico" -ForegroundColor Magenta
...
Write-Host " ⚙️  Handoff e Autonomia" -ForegroundColor Magenta
