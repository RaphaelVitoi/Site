          ...
          <div className="flex flex-col xl:flex-row gap-6 xl:gap-10">
            <div className="flex-1">
              <div className="mb-3">
                ...
                <p className="text-[0.45rem] text-text-darker max-w-[160px] leading-tight m-0 uppercase tracking-widest">Define a margem (SPR) e resistência estrutural.</p>
            ...
            <div className="flex-1">
              <div className="mb-3">
                ...
                <p className="text-[0.45rem] text-text-darker max-w-[160px] leading-tight m-0 uppercase tracking-widest">O Passivo (RIO) escala quadraticamente (N²).</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <div className={ `flex flex-col mb-2 ${ isHeroIP ? 'text-accent-indigo-light' : 'text-accent-danger' }` }>
                  ...
                  <p className="text-[0.45rem] text-text-darker max-w-[140px] leading-tight m-0 uppercase tracking-widest">Ajuste de under/over realization. R&lt;1 = perda de EQ.</p>
              ...
              <div>
                <div className="flex flex-col mb-2 text-accent-amber">
                  ...
                  <p className="text-[0.45rem] text-text-darker max-w-[140px] leading-tight m-0 uppercase tracking-widest">Agg extrema OOP destrói sua Realização (R).</p>
        ...
        <div className="bg-bg-deep/80 backdrop-blur-md border border-white/5 rounded-xl p-6 flex flex-col gap-5 shadow-2xl shadow-black/50">
          <div className="grid grid-cols-1 gap-6">
            <div className="flex flex-col">
              ...
              <p className="text-[0.45rem] text-text-darker max-w-[180px] leading-tight m-0 mb-2 uppercase tracking-widest">No vácuo. Cega para FGS, RIO e Pressão ICM.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex flex-col">
              ...
              <p className="text-[0.45rem] text-text-darker max-w-[140px] leading-tight m-0 mb-2 uppercase tracking-widest">Afrouxa a pressão de ICM se cobrimos o vilão.</p>
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[0.45rem] text-text-darker max-w-[140px] leading-tight m-0 mb-2 uppercase tracking-widest">Chance do vilão jogar Nash sem ceder ao Tilt.</p>
