...
export default function PmLensPanel ( { anteSize = 12.5, heroInvested = 1.125, currentPot = 2.5, activePlayers = 2, heroPosition: _heroPosition = 'BB', blindsRisingSoon = false, initialStacks = DEFAULT_STACKS, initialPrizes = DEFAULT_PRIZES }: Readonly<PmLensPanelProps> )
{
  ...
  const { streetMetrics } = usePmLensCalculations({
    initialStacks, initialPrizes, heroIdx, primaryVillainIdx, currentPot, heroInvested, equity, realizationFactor, deltaHabilidade, pkoValue, kappa, simulatedActivePlayers, absoluteHeroPos, blindsRisingSoon, activeNodelock
  });
