...
$Agents = @("dispatcher", "architect", "planner", "maverick", "auditor", "implementor", "verifier", "curator", "validador", "organizador", "sequenciador", "pesquisador", "prompter", "securitychief", "bibliotecario", "skillmaster", "chico")
