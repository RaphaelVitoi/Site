...
$description = @'
Agente @bibliotecario, inicie o protocolo de compressao de memoria.
...
Apague o ruido diario (ex: 'hoje eu aprendi que...', 'fui acionado para...') substituindo por dogmas atemporais daquele agente.
