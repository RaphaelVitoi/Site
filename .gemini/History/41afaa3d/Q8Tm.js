export class RiskGauge extends HTMLElement {
    ...
    render() {
        ...
        const isCritical = !isNaN(threshold) && value >= threshold;
        const color = isCritical ? '#ef4444' : baseColor; // Red-500 se crítico
        
        // Cálculo do dash array para animação SVG
        const dash = (value / 26) * 100; // Escala visual arbitrária para drama
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="gauge-wrap">
                ...
                <div class="center-text">
                    <span class="val" style="${isCritical ? 'color: #ef4444;' : ''}">${value.toFixed(1)}%</span>
