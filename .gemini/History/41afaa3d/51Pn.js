export class RiskGauge extends HTMLElement {
    ...
    static get observedAttributes() { return ['value', 'label', 'pos', 'stack', 'color']; }
    ...
    render() {
        ...
        const color = this.getAttribute('color') === 'pink' ? '#ec4899' : '#6366f1';
        
        // Cálculo do dash array para animação SVG
        const dash = (parseFloat(value) / 26) * 100; // Escala visual arbitrária para drama
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="gauge-wrap">
                ...
                <div class="center-text">
                    <span class="val">${parseFloat(value).toFixed(1)}%</span>
