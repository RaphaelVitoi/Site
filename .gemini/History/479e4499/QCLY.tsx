...
export default function PmLensPanel ( { anteSize = 12.5, heroInvested = 1.125, currentPot = 2.5, activePlayers = 2 }: Readonly<PmLensPanelProps> ) {
  ...
  }, [ heroIdx, villainIdx, equity, pkoValue, kappa, heroIsIp, anteSize, activePlayers, deltaHabilidade, streetProgression, ecosystem?.dispatchIcmPerspectiva, handleIcmResult ] );
