    ...
    return (
        <main className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <article className="animate-fade-up">
                <LessonHeader title="A Amortização da Edge" category="Biblioteca • Paradoxo da Competência" />

                <section className="glass-panel p-6 md:p-10 border border-white/10 shadow-2xl shadow-emerald-500/10 rounded-xl animate-fade-up animation-delay-200">
                ...
                <nav className="article-nav" style={{ marginTop: '4rem' }}>
                    <Link href="/biblioteca">&larr; Voltar para a Biblioteca</Link>
                </nav>
            </article>
        </main>
    );
