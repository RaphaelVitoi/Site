...
export const BUBBLE_STACKS = [ 22.18, 19.21, 23.22, 22.77, 40.0, 20.0, 31.12, 26.0 ];

export const BUBBLE_BF_MATRIX = [
    [ 0, 1.5310, 1.6687, 1.6678, 1.6928, 1.5648, 1.6822, 1.6741 ],
    [ 1.6185, 0, 1.6208, 1.6198, 1.6439, 1.6134, 1.6340, 1.6261 ],
    ...
    [ 1.4406, 1.3585, 1.4722, 1.4583, 1.7940, 1.3792, 0, 1.5657 ],
