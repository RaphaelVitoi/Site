...
export const metadata: Metadata = {
  ...
  description:
    "A Geometria do Risco: ICM Pós-Flop, Risk Premium e a Fronteira SOTA do Edge no Poker.",
  ...
  openGraph: {
    ...
    description:
      "A Geometria do Risco: ICM Pós-Flop e o Paradigma da Perspectiva Matemática.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Raphael Vitoi | Nexus",
    description:
      "A Nova Fronteira do Edge no Poker: ICM Pós-Flop e Inteligência Quantum.",
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body
        className={`${inter.variable} ${jetbrainsMono.variable} ${montserrat.variable} font-body antialiased bg-bg-base text-text-main flex flex-col min-h-screen selection:bg-accent-indigo/30 selection:text-text-bright`}
        suppressHydrationWarning
      >
        <AuthProvider>
          <SotaBackground />
          <SotaGlobalSyncProvider>
            <JsonLd data={rootSchema as Record<string, unknown>} />
            <Header />
            <main className="grow pt-20 flex flex-col relative">
              {children}
            </main>
            <Footer />
            <ScrollToTop />
