...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body
        className={`${inter.variable} ${jetbrainsMono.variable} ${montserrat.variable} font-body antialiased bg-bg-base text-text-main flex flex-col min-h-screen selection:bg-accent-indigo/30 selection:text-text-bright overflow-x-hidden w-full max-w-[100vw]`}
        suppressHydrationWarning
      >
        <AuthProvider>
          <SotaBackground />
