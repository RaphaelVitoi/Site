...
class SystemState:
    ...
    human_nonsense_factor: float = 0.0 # Frequencia de Besteira Humana (fb)
...
class PerspectiveEngine:
    ...
    def evaluate_spot(self, state: SystemState) -> Dict[str, Any]:
        ...
        # Base de utilidade assumindo equidade bruta + Influxo de Entropia Positiva (fb)
        raw_utility = 1.0 + ev_fold - rio + state.human_nonsense_factor
