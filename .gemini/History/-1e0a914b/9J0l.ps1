...
Write-Host "[OK] Ecossistema Nexus ancorado em: $ProfilePath" -ForegroundColor GreenWrite-Host "[OK] Ecossistema Nexus ancorado em: $ProfilePath" -ForegroundColor Green
