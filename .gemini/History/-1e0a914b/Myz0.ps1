...
Set-Alias -Name gemini -Value nexus

# --- Substituição de Aliases Nativos (Fricção Zero) ---
Remove-Item Alias:gc -Force -ErrorAction SilentlyContinue
function gc { gemini chat @args }
...
Write-Host "[OK] Ecossistema Nexus ancorado em: $ProfilePath" -ForegroundColor GreenWrite-Host "[OK] Ecossistema Nexus ancorado em: $ProfilePath" -ForegroundColor GreenWrite-Host "[OK] Ecossistema Nexus ancorado em: $ProfilePath" -ForegroundColor Green
