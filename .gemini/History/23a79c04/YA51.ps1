...
Write-Host "[SENTINELA] Relatório consolidado gerado em: $ReportPath" -ForegroundColor Green
Write-Host "[SENTINELA] Ciclo completo e telemetria sincronizada." -ForegroundColor Cyan