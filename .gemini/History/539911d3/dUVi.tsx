...
/*
 * SOTA FIX: Importações e estilos legados substituídos por stubs locais.
 * Isolamos as dependências deste arquivo de archive para erradicar a
 * entropia de compilação sem necessidade de deletar o histórico.
 */
const styles = { tickerWrap: 'tickerWrap', ticker: 'ticker' };
const ScenarioStage = ( { scenario }: any ) => <div />;
const TheoryPanel = ( { scenario }: any ) => <div />;
const PerspectivePanel = () => <div />;
const ComparisonRadar = ( { scenarios, currentId }: any ) => <div />;
const PmLensPanel = () => <div />;
type Scenario = any;
