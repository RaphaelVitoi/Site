...
def purify_text_to_ascii(text: str) -> str:
    ...
    mojibake_map = {
        ...
        'ÃƒÂ¢': 'a', 'ÃƒÂª': 'e', 'ÃƒÂ®': 'i', 'ÃƒÂ´': 'o', 'ÃƒÂ»': 'u',
        'ÃƒÂ£': 'a', 'ÃƒÂµ': 'o', 'ÃƒÂ§': 'c', 'ÃƒÂ': 'A', 'Ãƒâ€°': 'E',
        'ÃƒÂ': 'I', 'Ãƒâ€œ': 'O', 'ÃƒÅ¡': 'U', 'Ãƒâ€': 'A', 'ÃƒÅ': 'E',
        'ÃƒÅ½': 'I', 'Ãƒâ€': 'O', 'Ãƒâ€': 'U', 'ÃƒÆ’': 'A', 'Ãƒâ€¢': 'O',
        'Ãƒâ€¡': 'C', 'ÃƒÅ': 'U',
        # Corrupcoes de leitura hibrida mapeadas do contexto
        'ilusA3ria': 'ilusoria', 'resoluAAes': 'resolucoes', 'informaAAo': 'informacao',
        'estAtico': 'estatico', 'prAtica': 'pratica', 'dinAmica': 'dinamica',
        'ameaAa': 'ameaca', 'EsperanAa': 'esperanca', 'AntevisAo': 'antevisao',
        'instAncia': 'instancia', 'SAntese': 'sintese', 'decisAo': 'decisao',
        'Aµ': 'o', 'A§': 'c', 'A£': 'a', 'A¡': 'a', 'A©': 'e', 'A­': 'i'
    }
...
def purify_repo_memories():
    ...
    base_dir = Path(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../.claude/agent-memory')))
