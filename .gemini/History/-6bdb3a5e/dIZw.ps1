...
try {
    ...
    # SOTA: Pula os 2 mais recentes (garantia absoluta de retencao) e filtra o resto pela data
    $OldBackups = $AllBackups | Select-Object -Skip 2 | Where-Object { $_.LastWriteTime -lt $CutoffDate }
