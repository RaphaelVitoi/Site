...
1.  **Arquitetura de Referencia:** O `SOTA_REFERENCE_ARCHITECTURE.md` deve conter a topologia de diretorios, a funcao de cada script critico (do.ps1, task_executor.py, etc.), o fluxo de dados (CLI -> do.ps1 -> task_executor.py -> SQLite) e o papel dos 18 agentes. Use diagramas Mermaid para clareza.
