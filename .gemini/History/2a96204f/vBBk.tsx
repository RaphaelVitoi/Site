...
export default function MasterSimulator ()
{
    ...
    const apiQuantumMetrics = useMemo( () => (
        quantumPerspectiva && scenario.stacks && scenario.stacks.length > 0 ? computeQuantumMetrics( quantumPerspectiva, safeActivePlayers, safeHeroInvested, scenario.stacks ) : null
