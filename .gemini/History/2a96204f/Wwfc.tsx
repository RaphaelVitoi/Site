                                    ...
                                    <div className="mt-4 p-6 glass-panel border-accent-indigo/20 animate-sota-in">
                                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-5 gap-4">
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                {isLlamaProcessing && (
                                                    <button onClick={stopLlama} className="px-5 py-2 text-[0.7rem] font-bold uppercase tracking-widest bg-rose-500/10 text-rose-400 border border-rose-500/30 rounded-lg hover:bg-rose-500/20 transition-colors">
                                                        Abortar
                                                    </button>
                                                )}
                                            </div>
                                        ...
                                        {llamaError && (
                                            <div className="mb-4 text-rose-500 font-mono text-xs p-3 bg-rose-500/10 border border-rose-500/20 rounded-lg">{llamaError}</div>
                                        )}
