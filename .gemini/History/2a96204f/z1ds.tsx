...
export default function MasterSimulator ()
{
 ...
 e                                     <SimulatorNavigation activeTool={ activeTool } onSelectTool={ setActiveTool } />
                        ...
                        <footer className="border-t border-white/5 bg-bg-panel/20">
                            <div className="sota-container py-12 px-6">
                                <p className="text-label opacity-30">Motor SOTA v4.2 · Raphael Vitoi</p>
                            </div>
                        </footer>
