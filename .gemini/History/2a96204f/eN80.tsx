                ...
                <SotaWasmContext.Provider value={ wasmContextValue }>
                    <div className="min-h-screen bg-bg-base relative">
                        ...
                        <footer className="border-t border-white/5 bg-black/40 backdrop-blur-md relative overflow-hidden mt-12">
                            ...
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/4 h-[1px] bg-linear-to-r from-transparent via-white/40 to-transparent" />
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-accent-indigo/10 blur-[100px] rounded-full pointer-events-none" />
