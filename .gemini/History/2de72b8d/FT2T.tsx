  ...
  return (
    <div style={ {
      ...
      <span style={ { fontSize: '0.6rem', color: 'var(--text-dim)' } }>
        { label }
        { hint && (
          <span style={ { marginLeft: '0.3rem', fontSize: '0.55rem', color: 'var(--bg-subtle)' } }>
            { hint }
          </span>
        ) }
      </span>
  ...
  return (
    <div style={ {
      ...
      <MetricRow
        ...
        color={ result.deltaRp > 0 ? 'var(--accent-amber)' : 'var(--text-muted)' }
        hint="IP − OOP"
      />
      ...
      <div style={ { marginTop: '0.4rem', borderTop: '1px solid rgba(99,102,241,0.15)', paddingTop: '0.4rem' } }>
        ...
        <MetricRow
          ...
          color={ result.ciStreet < 1 ? 'var(--accent-amber)' : 'var(--accent-danger)' }
          hint={ result.ciStreet < 1 ? 'insolvente' : 'solvente' }
        />
        <MetricRow
          label="Valuation ICM"
