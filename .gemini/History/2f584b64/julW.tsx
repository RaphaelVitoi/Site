        ...
        <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body">
            ...
            <div className="max-w-300 mx-auto px-6 pt-12">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
                    <div>
                        <h1 className="text-[clamp(2rem,5vw,3.5rem)] font-black m-0 tracking-tighter bg-linear-to-r from-text-bright to-text-dim bg-clip-text text-transparent font-heading">
            ...
            <div className="max-w-300 mx-auto px-6 pb-24">
                <div className="bg-linear-to-br from-bg-elevated/60 to-bg-base p-12 rounded-3xl border border-white/5 text-center relative overflow-hidden">
