    ...
    return (
        <div style={ {
            ...
            <div style={ { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '1rem', borderTop: '1px solid var(--glass-border)', paddingTop: '1.25rem' } }>
                <div>
                    <div style={ { fontSize: '0.70rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' } }>EV Puro do Pote</div>
                ...
                <div>
                    <div style={ { fontSize: '0.70rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' } }>Externalidade</div>
                ...
                <div style={ { backgroundColor: 'rgba(255,255,255,0.03)', padding: '0.75rem', borderRadius: '6px', border: '1px solid var(--glass-border)' } }>
                    <div style={ { fontSize: '0.70rem', color: 'var(--accent-primary)', textTransform: 'uppercase', fontWeight: 'bold', letterSpacing: '0.05em' } }>Esperança Real</div>
