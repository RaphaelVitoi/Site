    ...
    return (
        <div className="min-h-screen text-slate-50 selection:bg-indigo-500/30 pb-20 pt-10 font-inter" style={{
            ...
            <style>{`
                ...
                /* Gauges e Barras (Física Masterpiece) */
                .circular-chart { display: block; margin: 0 auto; max-width: 140px; max-height: 140px; }
                .circle-bg { fill: none; stroke: rgba(30, 41, 59, 0.8); stroke-width: 2.5; }
                .circle { fill: none; stroke-width: 2.5; stroke-linecap: round; transition: stroke-dasharray 1.5s cubic-bezier(0.16, 1, 0.3, 1); }
                .circle.sky { stroke: #0ea5e9; filter: drop-shadow(0 0 8px rgba(14, 165, 233, 0.6)); }
                .circle.rose { stroke: #e11d48; filter: drop-shadow(0 0 8px rgba(225, 29, 72, 0.6)); }
                .bar-transition { transition: width 1.5s cubic-bezier(0.16, 1, 0.3, 1); }
                                    ...
                                    <div className="relative w-28 h-28 md:w-36 md:h-36">
                                        <svg viewBox="0 0 36 36" className="block mx-auto max-w-[140px] max-h-[140px]">
                                            ...
                                            <svg viewBox="0 0 36 36" className="circular-chart">
                                                ...
                                                <path className="circle sky" style={{ strokeDasharray: `${Math.min(100, (currentData.ip.rp / 26) * 100)}, 100` }} d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                            </svg>
                                ...
                                <div className="flex flex-col items-center flex-1">
                                    ...
                                    <div className="relative w-28 h-28 md:w-36 md:h-36">
                                        <svg viewBox="0 0 36 36" className="block mx-auto max-w-[140px] max-h-[140px]">
                                            ...
                                            <svg viewBox="0 0 36 36" className="circular-chart">
                                                <path className="circle-bg" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                                <path className="circle rose" style={{ strokeDasharray: `${Math.min(100, (currentData.oop.rp / 26) * 100)}, 100` }} d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                            </svg>
                                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <div className="glass-panel p-6 border-t-4 border-t-sky-500 hover:border-t-sky-400 transition-colors">
                                ...
                                <div>
                                    ...
                                    <div className="h-1.5 w-full bg-slate-800 rounded-full overflow-hidden mt-4 shadow-inner">
                                        ...
                                        <div className="h-full bg-sky-500 bar-transition" style={{ width: `${bluff}%` }}></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="glass-panel p-6 border-t-4 border-t-rose-500 hover:border-t-rose-400 transition-colors">
                                ...
                                <div>
                                    ...
                                    <div className="h-1.5 w-full bg-slate-800 rounded-full overflow-hidden mt-4 shadow-inner">
                                        ...
                                        <div className="h-full bg-rose-500 bar-transition" style={{ width: `${defense}%` }}></div>
                                    </div>
                                </div>
                            </div>
                        </div>
