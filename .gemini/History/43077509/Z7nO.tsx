    ...
    return (
        <div className="mb-6 animate-fade-up" style={{ animationDelay: '100ms' }}>
            <div className="flex justify-between items-center mb-3">
                <h3 className="font-heading font-semibold text-accent-sky uppercase tracking-widest text-xs flex items-center gap-2">
                    ...
                    return (
                        <button
                            ...
                            className={`px-4 py-2 text-xs font-semibold rounded border transition-all duration-300 ${isActive
                                    ? 'bg-accent-sky/20 text-accent-sky border-accent-sky shadow-[0_0_15px_rgba(56,189,248,0.3)]'
                                    : 'bg-slate-900/50 text-slate-400 border-white/5 hover:border-accent-sky/50 hover:text-white'
                                }`}
                        >
                            {scenario.name}
                        </button>
