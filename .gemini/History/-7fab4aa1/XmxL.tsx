...
export async function GET ( request: Request ) {
    try
    {
        ...
        const numPureEv = Number.parseFloat( pureEv );
        const numIcmEv = Number.parseFloat( icmEv );
    ...
    {
        console.error( '[API SOTA] Falha estrutural ao gerar a assinatura visual OG:', error );
        return new Response( `Falha ao gerar a assinatura visual do relatorio`, { status: 500 } );
    }
}
