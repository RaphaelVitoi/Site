              ...
              { navItems.map( ( item ) =>
              {
                ...
                return (
                  <li key={ item.href } className="relative">
                    <Link
                      href={ item.href }
                      className={ `relative z-10 px-5 py-2.5 text-[0.65rem] font-black uppercase tracking-[0.15em] transition-all duration-300 flex items-center gap-2 whitespace-nowrap ${ isActive ? 'text-white text-shadow-[0_0_10px_rgba(255,255,255,0.5)]' : 'text-slate-400 hover:text-white'
                        }` }
                    >
                      { item.label }
                    </Link>
          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col gap-2 mb-8">
                ...
                <Link href="/laboratorio-v2/gto-cfr" onClick={ closeMobile } className="py-2.5 text-lg font-bold text-text-main hover:text-white transition-colors flex items-center gap-4">
