        ...
        <div className="sota-container flex items-center justify-between gap-6">
          ...
          <div className="shrink-0">
            <Link href="/" className="group relative flex items-center gap-3 focus:outline-none">
              <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl bg-black/40 border border-white/10 shadow-[0_0_20px_rgba(255,255,255,0.05)] transition-all duration-700 group-hover:border-accent-indigo/50 group-hover:shadow-[0_0_30px_rgba(99,102,241,0.2)]">
                 ...
                 <i className="fa-solid fa-gem text-white text-lg group-hover:scale-110 transition-transform duration-700" />
              </div>
              <div className="flex flex-col justify-center">
                <span className="text-[1.1rem] font-black tracking-tighter text-white leading-none">
                  POKER<span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-indigo-light to-accent-emerald-light">RACIONAL</span>
                </span>
                <span className="text-[0.55rem] font-bold uppercase tracking-[0.3em] text-text-muted mt-1 leading-none">
                  Nexus System
                </span>
              </div>
            </Link>
