    ...
    <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body">
      ...
      <section id="hero" className="relative pt-40 pb-24 px-6 overflow-hidden">
        <div className="sota-container relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto animate-sota-in">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/artigos/estado-da-arte" className="bg-accent-rose text-white shadow-[0_4px_14px_rgba(225,29,72,0.25)] hover:bg-rose-500 hover:shadow-[0_8px_25px_rgba(225,29,72,0.4)] hover:-translate-y-0.5 px-12 py-5 text-lg font-black tracking-tighter rounded-2xl border-white/10 transition-all backdrop-blur-md">
              WHITEPAPER
            </Link>
          </div>
        </div>
      ...
      <div className="sota-container pb-32">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/simulador" className="hub-card border-accent-emerald/20">
          ...
          <Link href="/aulas/conceitos-icm" className="hub-card border-accent-amber/20">
