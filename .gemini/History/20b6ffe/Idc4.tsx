  ...
  return (
    <div className="glass-panel animate-fade-up" style={ { padding: '1.75rem' } }>
      ...
      >
        ...
        { isNodelockB20 ? 'A dinâmica foi travada. Agressor forçado a apostar pequeno para absorver fold equity sem inflar as RIOs.' : scenario.theory }
      </div>
      ...
      >
        ...
        <div style={ { textAlign: 'center' } }>
          ...
          />
          <p className="font-mono tabular-nums" style={ { fontSize: '0.65rem', color: 'var(--text-dim)', margin: '0.3rem 0 0', letterSpacing: '0.03em' } }>
