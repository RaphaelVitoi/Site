    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="p-6 rounded-xl bg-slate-900/40 border border-white/5 shadow-inner">
                <SotaTooltip title="Taxa de Maluquice (Axioma Lipe Piv)" content="Frequência estimada de erro emocional ou blefe irracional do oponente. Em ambientes de baixa qualidade técnica, este fator domina a regressão de edge." align="left" theme="entropy">
                    <div className="flex flex-col gap-3 cursor-help">
