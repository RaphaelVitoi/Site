...
def _append_agent_specific_protocols(agent_clean: str, system_prompt_parts: list) -> None:
    if agent_clean == "maverick":
        ...
        system_prompt_parts.append(f"=== PROTOCOLO DE AUDITORIA SENTINELA (NOTIFY- TASKS) ===\n{maverick_notify_instruction}\n\n")
    ...
    if agent_clean == "chico":
        ...
        system_prompt_parts.append(f"=== PROTOCOLO DE INTERVENCAO SISTEMICA (HANDOFF/AUTOFIX) ===\n{chico_system_instruction}\n\n")
