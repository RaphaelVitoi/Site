...
1. `data/intentmap.json` (Fonte da verdade de roteamento - deve refletir as 20 Entidades: Raphael + 19 Agentes IA).
...
- Verifique se TODOS os 19 agentes IA estao descritos nas listas de pipeline no `project-context.md` e `GLOBAL_INSTRUCTIONS.md`. (Recentemente o @architect, @seo, @guardian e @bibliotecario foram adicionados).
