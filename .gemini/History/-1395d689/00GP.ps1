...
1. `data/agents_manifest.json` (Fonte da verdade de roteamento - deve refletir os 17 Agentes IA).
...
- Verifique se TODOS os 17 agentes IA estao descritos corretamente nas listas de pipeline no `project-context.md` e `GLOBAL_INSTRUCTIONS.md`.
