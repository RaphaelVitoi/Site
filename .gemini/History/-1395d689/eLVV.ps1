...
1. `data/intentmap.json` (Fonte da verdade de roteamento - deve refletir a Triade + 17 Especialistas = 20 entidades (Raphael + 19 IAs)).
...
- Verifique se TODOS os 19 agentes estao descritos nas listas de pipeline no `project-context.md` e `GLOBAL_INSTRUCTIONS.md`. (Recentemente o @architect, @seo, @guardian e @bibliotecario foram adicionados, garanta que nao foram esquecidos no meio das documentacoes).
