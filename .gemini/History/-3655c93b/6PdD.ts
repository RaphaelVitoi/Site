...
export async function POST ( request: Request ) {
    try
    {
        ...
        /* SOTA: Comentado temporariamente até o fornecimento do schema.prisma real.
        ...
        */
        ...
        return NextResponse.json( { status: 'SUCCESS', message: 'Payload recebido e validado (Banco em standby)', data: body }, { status: 201 } );
    } catch ( error )
    {
