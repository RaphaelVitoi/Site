...
> Atualizado em: 2026-03-25 03:29:18
...
| nexus-status,                       |                       |               |
| nexus-keys,                         |                       |               |
| nexus-fallback 60                   | [MAGENTA]             |               |
| Operacao diaria                     |                       |               |
| nexus '`<tarefa>`', start-worker, |                       |               |
| nexus-list                          | [VERDE]               |               |
| Manutencao segura                   |                       |               |
| nexus-checkdb,                      |                       |               |
| nexus-fallback-prune 7,             |                       |               |
| nexus-backup                        | [AMARELO]             |               |
| Governanca/Mapa                     |                       |               |
| nexus-map,                          |                       |               |
| nexus-scripts,                      |                       |               |
| nexus-scripts-refresh               | [CIANO]               |               |
| Recovery controlado                 | stop-worker,          |               |
| nexus-fallback-prune-legacy         | [VERMELHO]            |               |
...
| [VERDE]    | start-worker                | Inicia worker+API                    | task_executor.py worker                       |
