...
$TrashFiles = @(
    ...
    "$ProjectRoot\queue\tasks.json"                             # Erradicacao definitiva do JSON velho
)
...
2. Gere uma estrutura de tarefas PARALELAS onde o @architect faz a topologia, o @auditor valida e o @implementor executa, usando a nova capacidade 'depends_on' do sistema DAG.
3. Objetivo: Enxugar e simplificar sem perder o Estado da Arte.
"@
