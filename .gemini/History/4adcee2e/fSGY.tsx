    ...
    return (
        <main className="container" style={ { maxWidth: '800px', margin: '0 auto', padding: '4rem 1.5rem' } }>
            ...
            <article>
                ...
                <p>A vantagem técnica sobre um oponente (Edge Relativa) não é constante; ela depende da profundidade da stack (Resolução do Jogo).</p>
                <ul style={ { marginLeft: '1.5rem', color: '#cbd5e1' } }>
                    <li><strong>100bb (Alta Resolução):</strong> A árvore de decisões é profunda. Há espaço para overbets, multi-barrels e outplays. A Edge se realiza em sua plenitude.</li>
                    <li><strong>10bb (Colapso Binário):</strong> A árvore é podada para Push/Fold. O jogador fraco é "protegido" pela mecânica limitada e pela matemática pura da colisão, neutralizando a habilidade do profissional.</li>
                </ul>
                <p>Manter um Short Stack vivo (dando fold ao invés de um call marginal) pode ter um EV altíssimo, pois preserva a pressão sistêmica sobre a mesa e evita "devolver" ferramentas de erro ao oponente fraco ao dobrá-lo.</p>
            </article>
