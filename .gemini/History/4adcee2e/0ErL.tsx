...
export default function LeituraICM () {
    ...
    style J fill:#7f1d1d,stroke:#ef4444,stroke-width:2px,color:#fff`}
                ...
                <p>O verdadeiro erro de um Chip Leader na bolha não é o call matemático com EV marginal positivo; é o call que devolve a complexidade da árvore de decisão ao oponente que estava confinado à simplicidade. Manter um Short Stack vivo (dando fold) possui um{ ' ' }<strong>EV Sistêmico Absurdo</strong>, pois você preserva a pressão da mesa (Risk Premium alto para os intermediários) e não transfere "ferramentas de erro" para a mão de um amador ao dobrá-lo.</p>
            </article>
