...
export default function CfrRegretPanel() {
  ...
  const paramsRef = useRef({ kappa: 0.85, nodes: 13 });
  useEffect(() => {
    paramsRef.current = { kappa, nodes };
  }, [kappa, nodes]);
  ...
  return (
    <GlassPanel className="flex flex-col gap-6 p-8 mt-8 animate-sota-in max-w-full overflow-hidden">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 border-b border-white/5 gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 bg-black/30 p-4 rounded-xl border border-white/5 shadow-inner">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-32 h-1.5 bg-white/10 rounded-full appearance-none outline-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:bg-accent-emerald [&::-webkit-slider-thumb]:rounded-full cursor-pointer"
            />
          </div>
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center w-32">
            ...
            <input
              ...
              className="w-32 h-1.5 bg-white/10 rounded-full appearance-none outline-none [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:bg-accent-indigo [&::-webkit-slider-thumb]:rounded-full cursor-pointer"
            />
          </div>
        </div>
