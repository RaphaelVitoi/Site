  ...
  useEffect(() => {
    ...
    worker.onmessage = (e) => {
      if (e.data.type === 'CFR_HEATMAP') {
        ...
        const cellW = width / nodes;
        const cellH = height / nodes;
        ...
        animationFrameId = requestAnimationFrame(() => {
          worker.postMessage({ type: 'CFR_HEATMAP', nodes, iterations: 1, id: 'cfr_loop' });
          worker.postMessage({ type: 'CFR_HEATMAP', nodes, iterations: 1, kappa: 0.85, id: 'cfr_loop' });
        });
      }
    };
