...
export default function MatchupSelector () {
  ...
  const effStack = agressorData && defensorData ? Math.min( agressorData.bb, defensorData.bb ) : 0;
  const amortizedCoefficient = effStack > 0 ? Math.max( 0.15, Math.min( 1.0, Math.log10( effStack ) / 2 ) ) : 0;
