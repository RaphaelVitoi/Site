...
export const SimulatorQuizWidget: React.FC<SimulatorQuizWidgetProps> = ({ simulatorState }) => {
    ...
    const questions = useMemo(() => {
        const generated = generateDynamicICMQuiz(simulatorState);
        ...
        return generated;
    }, [simulatorState, metricsCtx?.apiQuantumMetrics]);
    ...
    return (
        <div className="mt-16 border-t border-white/5 pt-12 relative">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
                ...
                >
                    <i className="fa-solid fa-ghost" /> {ghostMode ? 'Ocultar Solver' : 'Ghost Solver'}
                </button>
            </div>
