...
export default function RootLayout ( {
  ...
  return (
    <html lang="pt-BR" className="scroll-smooth" data-scroll-behavior="smooth">
      ...
      <body className="font-sans antialiased bg-slate-950 text-slate-300 flex flex-col min-h-screen selection:bg-indigo-500/30 selection:text-indigo-200 before:absolute before:inset-0 before:-z-10 before:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] before:from-indigo-900/10 before:via-slate-950/0 before:to-slate-950/0">
        <Header />
