...
type TablePlayer = { name: string; stack: string; angle: number; highlight: boolean };
type PrizeData = { pos: string; val: number };
            ...
            <div style={ { display: 'flex', flexDirection: 'column', gap: '1.5rem' } }>
              ...
              <div>
                ...
                <svg viewBox={ `0 0 ${W} ${H}` } style={ { display: 'block', width: '100%', maxWidth: `${W}px`, margin: '0 auto' } }>
                  ...
                  { TABLE_PLAYERS.map( ( { name, stack, angle, highlight }: TablePlayer ) => {
            ...
            <div style={ { display: 'flex', flexDirection: 'column', gap: '1.5rem' } }>
              ...
              <div style={ { marginTop: '0.5rem' } }>
                ...
                <div style={ { display: 'flex', flexDirection: 'column', gap: '6px' } }>
                  { PRIZES.map( ( { pos, val }: PrizeData, i: number ) => {
