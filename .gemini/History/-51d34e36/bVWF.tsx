              ...
              <div style={{ marginTop: '0.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  {PRIZES.map(({ pos, val }, i) => {
                    ...
                    const visualWidthPct = (val / PRIZES[0].val) * 100; // Ancoragem visual para manter a percepção de inclinação
                    ...
                    return (
                      <div key={pos} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        ...
                        <div style={{ flex: 1, height: '6px', borderRadius: '4px', background: 'rgba(255,255,255,0.05)', overflow: 'hidden' }}>
                          <div style={{ width: `${visualWidthPct}%`, height: '100%', borderRadius: '4px', background: barBg }} />
                        </div>
