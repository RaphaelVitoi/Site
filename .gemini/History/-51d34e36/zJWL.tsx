    ...
    <div id="anchor-aula12" style={ { maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem' } }>
      <details style={ { borderBottom: '1px solid rgba(255,255,255,0.06)' } }>
        ...
        <div style={ { display: 'flex', flexDirection: 'column', gap: '3rem', paddingBottom: '3rem', paddingTop: '1rem' } }>
          ...
          <div style={ { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 360px), 1fr))', gap: '3rem', width: '100%' } }>
          ...
          <div style={ { marginTop: '1.5rem' } }>
            ...
            <div style={ {
              ...
              { [
                ...
                {
                  term: 'RIO / EV_fold',
                  def: 'Reverse Implied Odds e Valor de Desistência. EV_fold nunca é 0. RIO é a antimatéria das pot odds, explodindo quadraticamente em potes Multiway.',
                },
              ].map( ( { term, def } ) => (
