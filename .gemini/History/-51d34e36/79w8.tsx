...
export default function ReferencialAula12 () {
  ...
  const mPlayers = isFT ? BF_PLAYERS : isBubble ? BUBBLE_PLAYERS : EG_PLAYERS;
  const mStacks = isFT ? BF_STACKS : isBubble ? BUBBLE_STACKS : EG_STACKS;
  const mBf = isFT ? BF_MATRIX : isBubble ? BUBBLE_BF_MATRIX : EG_BF_MATRIX;
  const mRp = isFT ? RP_MATRIX : isBubble ? BUBBLE_RP_MATRIX : EG_RP_MATRIX;
