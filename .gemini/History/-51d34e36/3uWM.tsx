          ...
          <div style={ { marginTop: '1rem' } }>
            ...
            <div style={ {
              ...
              <div style={ { flex: '0 0 auto', width: '100%', maxWidth: '420px' } }>
                <RangeHeatmap matrix={ convertToHeatmapMatrix( BTN_FREQS, 'aggressor' ) } title="BTN (RFI)" subtitle="33.6% open" />
              </div>
              <div style={ { flex: '0 0 auto', width: '100%', maxWidth: '420px' } }>
                <RangeHeatmap matrix={ convertToHeatmapMatrix( BB_FREQS, 'defender' ) } title="BB (Defesa)" subtitle="82.9% continue" />
              </div>
            </div>
          </div>
