...
function RangeGrid({ freqs, color, title, pct }: {
  ...
  return (
    <div>
      <p style={{ margin: '0 0 0.8rem', fontSize: '0.95rem', fontWeight: 700, color: accentColor, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
        ...
        <table style={{ borderCollapse: 'collapse', fontSize: '0.85rem' }}>
          <thead>
            <tr>
              <th style={{ width: '24px' }} />
              {RANKS.map(r => (
                <th key={r} style={{ width: '42px', padding: '4px', textAlign: 'center', color: '#64748b', fontWeight: 700, fontSize: '0.85rem' }}>{r}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {RANKS.map((rowRank, r) => (
              <tr key={rowRank}>
                <td style={{ padding: '4px 6px 4px 0', color: '#64748b', fontWeight: 700, fontSize: '0.85rem', textAlign: 'right' }}>{rowRank}</td>
                {RANKS.map((_, c) => {
      ...
      <details style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem', paddingBottom: '3rem', paddingTop: '1rem' }}>
          ...
          <div style={{ marginTop: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem 3rem', alignItems: 'flex-start' }}>
          ...
          {/* PM Lens — Framework PM incidindo sobre o Referencial */}
          <PmLensPanel />
