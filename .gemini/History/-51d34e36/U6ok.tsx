        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', paddingBottom: '2.5rem', paddingTop: '1rem' }}>
                ...
                <div style={{ marginTop: '1rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '0.6rem' }}>
                  {(() => {
                    ...
                    return ([
                      ...
                      { tag: 'FLAT', icon: '▬', color: '#94a3b8', text: `Ref. atual: ≈${pct1}% do pool total. Posições inferiores se valorizam. Laddering equilibrado e constante.`, active: true },
                      { tag: 'HÍBRIDA', icon: '◆', color: '#c4b5fd', text: 'Foge dos extremos (20–24%). Meio-termo. Avalie a inclinação dos saltos para o topo caso a caso.', active: false },
          ...
          <div style={{ marginTop: '1rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '1rem', marginBottom: '1rem' }}>
              <p style={{ margin: 0, fontSize: '0.85rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Bubble Factors</p>
