          ...
          <div style={ { marginTop: '1.5rem' } }>
            ...
            <div style={ { display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', marginBottom: '1.2rem' } }>
              ...
              <div style={ { display: 'flex', background: 'rgba(15,23,42,0.6)', borderRadius: '6px', padding: '4px', border: '1px solid rgba(255,255,255,0.05)' } }>
                ...
                <button onClick={ () => setMatrixView( 'BUBBLE' ) } style={ { padding: '6px 12px', fontSize: '0.8rem', fontWeight: !isFT ? 800 : 500, color: !isFT ? 'var(--text-light)' : 'var(--text-dim)', background: !isFT ? 'rgba(245,158,11,0.2)' : 'transparent', borderRadius: '4px', border: 'none', cursor: 'pointer', transition: 'all 0.2s' } }>Bolha (26 Left)</button>
              </div>
            </div>
