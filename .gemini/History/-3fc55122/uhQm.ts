...
import init, { solve_icm_distortion_binary } from '../../../../wasm-equity/pkg/vitoi_equity_engine.js';
...
globalThis.onmessage = async ( event: MessageEvent ) =>
{
    ...
    const result = solve_icm_distortion_binary( ip_rp, oop_rp, topologic_aggression, active_players, freqs );
