    ...
    return (
        <Link href="/" aria-label="Poker Racional - Início" className={`flex items-center gap-3 group focus:outline-none ${className}`}>
            <svg
                ...
                className="transition-transform duration-300 group-hover:rotate-[-5deg] group-hover:scale-110"
            >
                <defs>
            ...
            <span className="hidden sm:inline text-xl font-black tracking-tighter text-slate-200 transition-colors group-hover:text-white">
