      ...
      <div className="flex flex-wrap gap-1.5 bg-slate-900/40 p-2.5 rounded-lg">
        { stacks.map( ( s, i ) => {
          ...
          return (
            ...
            <div key={ label } className={`flex flex-col gap-0.5 px-1.5 py-1 rounded min-w-[55px] border ${isActive ? 'bg-indigo-500/10 border-indigo-500/20' : 'bg-transparent border-white/5'}`}>
