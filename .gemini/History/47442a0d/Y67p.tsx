...
export const MetricTooltip = ( { title, desc, children }: { title: string, desc: string, children: React.ReactNode } ) => (
    <div className="relative group cursor-help h-full flex flex-col">
        { children }
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-[85vw] sm:w-72 p-4 bg-[#0a0f1c] border border-teal-900/50 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-[100] pointer-events-none">
        ...
        <div className="flex flex-col w-full bg-black text-neutral-300 font-mono border border-neutral-900 rounded-xl shadow-[0_0_40px_rgba(0,0,0,0.8)] relative">
            <div className="flex justify-between items-center px-5 py-4 bg-[#030303] border-b border-neutral-900/60 rounded-t-xl">
                <div className="flex flex-col">
                    <MetricTooltip title="Tensão Decisional" desc="Representa o nível de pressão estrutural exercida pelo ICM. Quanto maior a tensão, mais restrito e polarizado torna-se o range ótimo de sobrevivência.">
            ...
            <div className="flex justify-between items-center px-6 py-5 bg-[#080808] border-b border-neutral-900/50 text-xs relative">
                <div className="flex gap-6">
                    <div className="flex flex-col">
                        <MetricTooltip title="Stack Hero" desc="A fundação da sua Perspectiva Matemática. Em ICM, cada ficha perdida dói mais do que o valor da ficha ganha.">
                    ...
                    <MetricTooltip title="Stack Villain" desc="Ameaça estrutural. O Bubble Factor é derivado primariamente da relação entre a sua stack e a stack do oponente.">
                        <button
                ...
                <div className="flex flex-col text-right">
                    <MetricTooltip title="Dead Money (Pot)" desc="O oxigênio. Potes maiores amortecem a pressão do Risk Premium. Potes limpos (sem dead money) exigem equidade pura extrema para justificar colisões.">
