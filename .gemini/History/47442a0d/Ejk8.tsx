...
const MetricTooltip = ( { title, desc, children }: { title: string, desc: string, children: React.ReactNode } ) => (
    ...
    return (
        <div className="flex flex-col w-full bg-neutral-950 text-neutral-300 font-mono border border-neutral-800 rounded-md overflow-hidden shadow-2xl">
            <div className="flex justify-between items-center px-4 py-3 bg-neutral-900 border-b border-neutral-800">
                ...
                <span className="text-xs text-neutral-500">{ spot.isBaseline ? 'ChipEV Baseline' : 'Motor ICM / FGS' }</span>
            </div>

            {/* TRACKER DE ESTADO ATUALIZADO (PÓS-SUNK COST) */ }
            <div className="flex justify-between items-center px-6 py-4 bg-[#050505] border-b border-neutral-900 text-xs">
                <div className="flex gap-6">
                    <div className="flex flex-col">
                        <span className="text-neutral-500 font-bold tracking-widest uppercase mb-1">Seu Stack</span>
                    ...
                    <div className="w-px h-10 bg-neutral-800 my-auto" />
                    <div className="flex flex-col">
                        <span className="text-neutral-500 font-bold tracking-widest uppercase mb-1">Oponente</span>
                        <span className="text-amber-700/80 text-lg font-light">{ spot.villainStack.toFixed( 1 ) } <span className="text-xs text-neutral-600">bb</span></span>
                        <span className="text-[9px] text-neutral-500 uppercase mt-1">{ spot.villainRole }</span>
                    </div>
                </div>
                <div className="flex flex-col text-right">
                    <span className="text-neutral-500 font-bold tracking-widest uppercase mb-1">Dead Money</span>
                ...
                <div className="flex flex-col bg-neutral-950 p-6">
                    <MetricTooltip title="Distorção Estratégica" desc="Representação visual do desvio comportamental exigido pelo ICM. Um Risk Premium alto dilata a frequência de Fold, obliterando os limites permissivos de ChipEV puro.">
                        ...
                        <div className="flex-1 w-full mt-2 rounded border border-neutral-800 flex overflow-hidden relative">
                            ...
                            <div className="h-full bg-neutral-800/50 flex items-center justify-center relative transition-all duration-700" style={ { width: spot.isBaseline ? '40%' : '60%' } }>
                        ...
                        <div className="mt-4 flex justify-between text-[9px] font-bold uppercase tracking-widest text-neutral-600">
