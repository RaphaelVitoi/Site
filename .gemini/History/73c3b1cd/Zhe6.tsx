...
interface DegradationChartProps {
    ...
    readonly fb?: number;
    // SOTA: Retrocompatibilidade estrutural (Drift do TheoryPanel)
    readonly perspectivaBase?: number;
    readonly potOddsPct?: number;
    readonly potSizePct?: number;
}

export default function DegradationChart( { sEff = 40, riskAversion = 1.5, fb = 0, perspectivaBase, potOddsPct: legacyPotOdds, potSizePct }: DegradationChartProps ) {
