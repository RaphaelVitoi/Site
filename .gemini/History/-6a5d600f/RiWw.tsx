...
function IcmRulers({ matrixView, setMatrixView, matrixData }: Readonly<{ matrixView: MatrixViewMode, setMatrixView: (v: MatrixViewMode) => void, matrixData: { mPlayers: string[], mStacks: number[], mBf: number[][], mRp: number[][] } }>) {
