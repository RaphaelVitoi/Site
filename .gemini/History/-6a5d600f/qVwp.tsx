        ...
        >
            { grid.flat().map( ( cell, i ) => {
              ...
              return (
                ...
                <div key={ handLabel } className={`relative group/cell overflow-hidden rounded-sm aspect-square transition-all duration-300 ${isEmpty ? 'bg-slate-900/40 border border-white/5' : 'bg-slate-950/80 border border-white/10 hover:z-20 hover:scale-[1.15] hover:shadow-[0_0_15px_rgba(255,255,255,0.2)]'}`}>
