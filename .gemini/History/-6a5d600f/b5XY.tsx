  ...
  return (
    <div id="anchor-aula12" className="w-full">
      <details className="group">
        <summary className="cursor-pointer list-none flex items-center justify-between gap-4 p-8 sm:p-10 lg:p-12 hover:bg-white/5 transition-all select-none outline-none border-b border-white/5">
          <div className="flex items-center gap-6">
            <div className="w-12 h-12 rounded-2xl bg-accent-indigo/10 border border-accent-indigo/20 flex items-center justify-center text-accent-indigo transition-transform group-open:rotate-90">
                <i className="fa-solid fa-chevron-right" />
            </div>
            <div className="flex flex-col gap-1">
                <span className="text-[0.6rem] font-black uppercase tracking-[0.4em] text-accent-indigo-light">Camada 01</span>
                <h3 className="text-lg sm:text-xl font-black text-white m-0 tracking-tight uppercase">Referencial Empírico</h3>
            </div>
          </div>
          <div className="hidden sm:flex items-center gap-4 text-[0.65rem] font-black uppercase tracking-widest text-text-darker">
             <span>BTN {rpBtn}% RP</span>
             <span className="opacity-30">|</span>
             <span>BB {rpBb}% RP</span>
          </div>
        </summary>

        <div className="flex flex-col gap-16 p-8 sm:p-10 lg:p-12 animate-sota-in">
          ...
          <div className="pt-16 border-t border-white/5">
            <div className="glass-panel border border-white/10 p-0 overflow-hidden relative group rounded-4xl bg-black/40">
              <div className="absolute top-0 right-0 w-150 h-150 bg-linear-to-bl from-accent-indigo/20 to-accent-danger/10 blur-[150px] pointer-events-none rounded-full transform translate-x-1/4 -translate-y-1/4 opacity-50" />

              <div className="p-10 sm:p-12 lg:p-16 relative z-10">
                <div className="flex items-center gap-4 mb-10">
                    <div className="w-2.5 h-2.5 rounded-full bg-accent-indigo shadow-[0_0_15px_var(--accent-indigo)]" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                  <div className="flex flex-col gap-6 justify-center">
                    <h4 className="text-[0.8rem] font-black text-white uppercase tracking-[0.25em]">
                    ...
                    <div className="bg-black/60 border border-white/10 rounded-2xl p-8 mt-4 shadow-inner grid grid-cols-2 gap-8">
                        <div className="flex flex-col gap-2">
                            <span className="text-[0.6rem] font-black uppercase tracking-widest text-text-darker">BF BTN</span>
                            <span className="text-2xl font-mono font-black text-white">{bfBtn.toFixed(2)}x</span>
                        </div>
                        <div className="flex flex-col gap-2">
                            <span className="text-[0.6rem] font-black uppercase tracking-widest text-accent-danger/60">BF BB</span>
                            <span className="text-2xl font-mono font-black text-accent-danger">{bfBb.toFixed(2)}x</span>
                        </div>
                    </div>
                  </div>

                  <div className="flex flex-col gap-6">
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all hover:border-white/20 shadow-lg group/diag">
                        <h4 className="text-[0.7rem] font-black text-accent-amber uppercase tracking-widest mb-3 flex items-center gap-3">
                            <i className="fa-solid fa-triangle-exclamation text-base" /> Vulnerabilidade RIO
                        </h4>
                        <p className="text-[0.75rem] text-text-muted leading-relaxed m-0 font-medium">
                            O range do BB contém diversas mãos marginais (ex: K2s, J8o) que, apesar de acertarem o board <span className="font-mono text-white bg-white/10 px-1.5 py-0.5 rounded">K-J-T-2-3</span>, sofrem de <strong>Reverse Implied Odds severas</strong>. O custo de continuar na mão sem o nuts é inflado pelo Bubble Factor de {bfBb.toFixed(2)}x.
                        </p>
                    </div>

                    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all hover:border-white/20 shadow-lg group/diag">
                        <h4 className="text-[0.7rem] font-black text-accent-emerald uppercase tracking-widest mb-3 flex items-center gap-3">
                            <i className="fa-solid fa-bullseye text-base" /> Diretriz de Exploração
                        </h4>
                        <p className="text-[0.75rem] text-text-muted leading-relaxed m-0 font-medium">
