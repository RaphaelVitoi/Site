        ...
        <div className="flex flex-col gap-12 pb-12 pt-4">
          ...
          <div style={{ marginTop: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', marginBottom: '1.2rem' }}>
              ...
              <div style={{ display: 'flex', background: 'rgba(15,23,42,0.6)', borderRadius: '6px', padding: '4px', border: '1px solid rgba(255,255,255,0.05)' }}>
                <button onClick={ () => setMatrixView( 'FT' ) } style={{ padding: '6px 12px', fontSize: '0.8rem', fontWeight: isFT ? 800 : 500, color: isFT ? 'var(--text-light)' : 'var(--text-dim)', background: isFT ? 'rgba(99,102,241,0.2)' : 'transparent', borderRadius: '4px', border: 'none', cursor: 'pointer', transition: 'all 0.2s' }}>FT (Aula 1.2)</button>
                <button onClick={ () => setMatrixView( 'BUBBLE' ) } style={{ padding: '6px 12px', fontSize: '0.8rem', fontWeight: isBubble ? 800 : 500, color: isBubble ? 'var(--text-light)' : 'var(--text-dim)', background: isBubble ? 'rgba(245,158,11,0.2)' : 'transparent', borderRadius: '4px', border: 'none', cursor: 'pointer', transition: 'all 0.2s' }}>Bolha (26 Left)</button>
                <button onClick={ () => setMatrixView( 'EG' ) } style={{ padding: '6px 12px', fontSize: '0.8rem', fontWeight: isEG ? 800 : 500, color: isEG ? 'var(--text-light)' : 'var(--text-dim)', background: isEG ? 'rgba(52,211,153,0.2)' : 'transparent', borderRadius: '4px', border: 'none', cursor: 'pointer', transition: 'all 0.2s' }}>Early Game (3ª Mão)</button>
