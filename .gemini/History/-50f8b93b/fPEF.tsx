...
function ActionRow ( {
  ...
  return (
    <div className="grid grid-cols-[65px_75px_20px_1fr_65px] items-center gap-2 py-1.5 border-b border-white/5 last:border-none">
      <span className="text-[0.6rem] font-black uppercase tracking-tighter flex items-center gap-1" style={{ color: accent }}>
      ...
      <div className="flex flex-col items-end gap-1 shrink-0">
        <span className="text-[0.6rem] font-bold font-mono tabular-nums" style={{ color: deltaColor( result.delta ) }}>{ fmt( result.delta ) }</span>
  ...
  return (
    <div className="glass-panel flex flex-col gap-4 p-5 sm:p-6 transition-all duration-300">
      ...
      <div className="flex justify-between items-start">
        ...
        <span className="px-2 py-0.5 rounded bg-slate-900/60 border border-white/10 text-[0.6rem] font-black font-mono tabular-nums whitespace-nowrap" style={{ color: deltaRp > 0 ? 'var(--accent-amber)' : 'var(--accent-emerald)' }}>
        ...
        { ( [ 'flop', 'turn', 'river' ] as const ).map( s => {
          ...
          return (
            <button
                ...
                style={{ borderColor: isActive ? d.color : undefined, color: isActive ? d.color : 'var(--text-darker)' }}
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-3 bg-white/5 rounded-xl border border-white/5 mb-1">
        <div>
          ...
          <span className="text-[0.85rem] font-black font-mono tabular-nums" style={{ color: current.color }}>{ ipRp.toFixed( 1 ) }%</span>
        </div>
        <div>
