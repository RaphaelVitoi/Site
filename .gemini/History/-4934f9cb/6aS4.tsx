...
export default function Dashboard () {
    ...
    const pendingTasks = Array.isArray( statusData ) ? statusData.filter( ( t: any ) => t.status === 'pending' ).length : 0;
    const activeWorkers = Array.isArray( statusData ) ? statusData.filter( ( t: any ) => t.status === 'processing' ).length : 0;
