...
export default function Dashboard () {
    ...
    const { data: statusData, error: statusError, isLoading: statusLoading } = useSWR<TaskStatus[]>( `${API_BASE}/status`, fetcher, { refreshInterval: 3000 } );
    const { data: keysData } = useSWR<KeyHealthSummary>( `${API_BASE}/key-health-summary`, fetcher, { refreshInterval: 10000 } );
