...
export const BUBBLE_BF_MATRIX = [
  [1, 1.15, 1.18, 1.25, 1.32, 1.35, 1.4, 1.45, 1.55],
  [1.52, 1, 1.58, 1.65, 1.7, 1.78, 1.9, 2.12, 2.3],
  [1.64, 1.68, 1, 1.75, 1.82, 1.92, 2.1, 2.35, 2.5],
  [1.7, 1.75, 1.8, 1, 1.95, 2.05, 2.25, 2.5, 2.7],
  [1.8, 1.85, 1.92, 2, 1, 2.1, 2.3, 2.65, 2.85],
  [1.85, 1.91, 1.98, 2.05, 2.15, 1, 2.45, 2.78, 3],
  [2, 2.1, 2.2, 2.3, 2.4, 2.55, 1, 3.1, 3.35],
  [2.12, 2.25, 2.38, 2.52, 2.65, 2.8, 3, 1, 3.45],
  [2.65, 2.85, 3.12, 3.3, 3.48, 3.7, 3.95, 4.2, 1]
];
