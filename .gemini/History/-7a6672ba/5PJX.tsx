        ...
        <div className={ styles.headerWrapper }>
            <div className={ styles.headerMain }>
                ...
                <div className={ styles.headerControls }>
                    <Link href="/" className="inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-mono font-bold uppercase tracking-widest text-slate-400 bg-slate-900/50 hover:bg-slate-800 hover:text-emerald-400 border border-white/5 hover:border-emerald-500/30 rounded-lg transition-all duration-300 shadow-inner group">
                        <span className="group-hover:-translate-x-1 transition-transform duration-300">&larr;</span> Início
                    </Link>
