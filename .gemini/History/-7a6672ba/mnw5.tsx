...
export default function SimulatorHeader( { scenarioName, stacks, effectiveIpRp, effectiveOopRp, rpSource, sidebarOpen, onToggleSidebar }: Readonly<SimulatorHeaderProps> ) {
    return (
