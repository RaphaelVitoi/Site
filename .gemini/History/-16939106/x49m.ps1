...
$description = "Planejar a arquitetura e os componentes React (Next.js) para a Calculadora/Simulador de ICM (Independent Chip Model - EXCLUSIVAMENTE POKER, ZERO RELACAO COM FINANCAS OU MERCADO CORPORATIVO). " +
"O objetivo e criar uma interface no frontend que permita ao usuario (jogador de poker) inserir stacks (em fichas) e payouts do torneio para calcular o Risk Premium em tempo real. " +
"Consulte as regras e PRDs de poker na pasta docs/tasks/aula-icm-rp e formule uma SPEC.md clara para o @implementor focar apenas em codar o Next.js."
