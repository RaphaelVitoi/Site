...
export function GtoCfrSimulator ()
{
    ...
    if ( !isHydrated ) return (
        <div className="flex flex-col items-center justify-center p-24 w-full min-h-[500px] bg-black/20 animate-pulse rounded-4xl border border-white/5 shadow-[inset_0_0_50px_rgba(0,0,0,0.5)]">
                ...
                <div className="glass-panel p-8 rounded-3xl border border-accent-emerald/20 flex flex-col gap-6 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-2 gap-6 mt-auto relative z-10">
                        <div className="space-y-1">
                            ...
                            <input type="range" min="0" max="1" step="0.05" value={ priorBelief } onChange={ e => setPriorBelief( Number.parseFloat( e.target.value ) ) } className="w-full h-1.5 bg-white/10 rounded-full appearance-none cursor-pointer accent-accent-emerald" />
                        </div>
                        <div className="space-y-1">
                            <div className="flex justify-between text-[0.55rem] font-black text-text-muted uppercase tracking-widest">
                                <span>P(Bluff)</span>
                            ...
                            <input type="range" min="0" max="1" step="0.05" value={ actionProb.blf } onChange={ e => setActionProb( { ...actionProb, blf: Number.parseFloat( e.target.value ) } ) } className="w-full h-1.5 bg-white/10 rounded-full appearance-none cursor-pointer accent-accent-amber" />
                        </div>
                    </div>
                </div>
