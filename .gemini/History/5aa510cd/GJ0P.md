...
4. Error Handling Robusto (`do.ps1`, `status.ps1`) - ✅
5. MCP Playwright Removido (`.vscode/mcp.json`) - ✅
6. Clareza: project-context vs MANUAL (`docs/MANUAL_WORKFLOW_AGENTES.md`) - ✅

### MÉDIAS - Implementadas

7. Hierarquia de Memória Clarificada (este arquivo) - ✅
8. Task Queue Schema Normalizado - Em backlog

### BAIXAS - Pendentes

9. Troubleshooting na MANUAL - Em backlog
10. Settings.local.json Refatorado - Em backlog
