...
if ($Web) {
    ...
    Write-Host '1. Claude 4.x Sonnet / Opus (Codificacao Cirurgica e Paranoia Tecnologica)'
    Write-Host '2. Gemini 3.1 Pro / 3.0 Flash (Contexto Massivo, RAG e Visao Holistica)'
