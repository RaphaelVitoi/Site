...
if ($Web) {
    ...
    Write-Host '2. Gemini 2.0 Flash / Pro Exp (Contexto Massivo, RAG e Visao Holistica)'
    Write-Host '2. Gemini 2.0 Flash / 1.5 Pro (Contexto Massivo, RAG e Visao Holistica)'
