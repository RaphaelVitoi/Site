...
if ($Description) {
    ...
    if ($CortexOverride) {
        ...
        Write-Host '[SEC ALERTA] CORTEX_OVERRIDE_DIRECTIVE ativada. O bloqueio de Antevisao Semantica e validacao estrita do CORTEX SHIELD foi suspenso pelo CEO para esta tarefa.' -ForegroundColor Red
    }
