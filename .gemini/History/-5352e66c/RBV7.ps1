...
if ($PSBoundParameters.ContainsKey('Autonomy')) {
    $Labels = @{
        ...
        'stop'    = 'W0 - Homeostase Sistemica (Auto-cura e Seguranca)'
        'default' = 'W1 - Homeostase Estendida (Fixes sem terminal)'
        'partial' = 'W2 - Estrategista Hibrido (Equilibrio Bayesiano, Baixo Impacto)'
        'full'    = 'W3 - Motor de Inovacao (Agencia Total e Refatoracao Proativa)'
    }
