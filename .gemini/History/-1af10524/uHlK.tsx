            ...
            <p className="mt-2 mb-0 text-xs text-text-muted leading-relaxed max-w-145">
              <span
                dangerouslySetInnerHTML={{
                  __html:
                    'Um framework de alta resolução que desloca a análise do Poker de um modelo de &ldquo;estado&rdquo; estático (<span class="whitespace-nowrap">ICM<sub>ev</sub></span>) para uma análise de &ldquo;fluxo&rdquo; dinâmica, integrando Teoria dos Sistemas, Lógica Bayesiana e Psicologia.',
                }}
              />
            </p>
        ...
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <ul className="ml-6 text-text-main leading-relaxed list-disc">
              <li>
                <span
                  dangerouslySetInnerHTML={{
                    __html:
                      '<strong>ChipEV:</strong> <span class="whitespace-nowrap">EV<sub>fold</sub></span> = &minus;antes. O piso é negativo. Para uma ação ser coerente, ela não precisa ter EV positivo, basta superar o abismo do fold.',
                  }}
                />
              </li>
              <li>
                <span
                  dangerouslySetInnerHTML={{
                    __html:
                      '<strong>O Paradoxo do ICM:</strong> Em bolhas ou payjumps, o <span class="whitespace-nowrap">EV<sub>fold</sub></span> pode ser <strong>Positivo</strong> (&ldquo;passar a vez&rdquo; gera valor passivo). No pós-flop, o <strong>Pot Entrapment</strong> torna o <span class="whitespace-nowrap">EV<sub>fold</sub></span> violentamente negativo (desistir do pote custa exponencialmente mais em valuation do que o risco residual). O <span class="whitespace-nowrap">ICM<sub>ev</sub></span> calcula isso como um &ldquo;snapshot&rdquo; (como se o torneio acabasse na mão atual).',
                  }}
                />
              </li>
            </ul>
            ...
            <div className="callout callout-secondary my-8">
              <p
                className="font-mono text-[0.85rem] text-text-main leading-relaxed mb-2"
                dangerouslySetInnerHTML={{
                  __html:
                    'Esperança(ação) = P(win) &times; <span class="whitespace-nowrap">&Delta;Perspectiva<sub>ganho</sub></span> + P(lose) &times; <span class="whitespace-nowrap">&Delta;Perspectiva<sub>perda</sub></span>',
                }}
              />
              <p className="mb-0">
                <strong>
        ...
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <p
              dangerouslySetInnerHTML={{
                __html:
                  'Pot Odds são uma heurística engessada de finanças básicas. Elas mascaram as <strong>Reverse Implied Odds (RIO)</strong>. Pagar pelas odds atrai a especulação, prendendo o jogador a um passivo estrutural onde ele acerta a mão marginal e perde um pote gigantesco. Na Perspectiva, um <span class="whitespace-nowrap">EV<sub>fold</sub></span> negativo é superior a um investimento barato insolvente.',
              }}
            />
          </div>
        </div>
            ...
            <ul className="ml-6 text-text-main leading-relaxed list-disc">
              ...
              <li>
                <span
                  dangerouslySetInnerHTML={{
                    __html:
                      "<strong>&Delta;RP (Diferencial de Risco):</strong> RP<sub>IP</sub> &minus; RP<sub>OOP</sub>. A subtração representa quanto a maior stack (RP menor) pode agredir proporcionalmente, e define o teto abstrativo de defesa para a stack menor (RP maior).",
                  }}
                />
              </li>
              <li>
          ...
          <ul className="m-0 pl-5 list-disc flex flex-col gap-2 text-[0.7rem] text-text-dim leading-relaxed">
            <li>
              ...
              <span
                dangerouslySetInnerHTML={{
                  __html:
                    '<span class="whitespace-nowrap">k<sub>A</sub></span>',
                }}
              />{" "}
