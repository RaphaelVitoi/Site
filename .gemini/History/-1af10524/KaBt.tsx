      ...
      <div className="max-w-[1200px] mx-auto pt-6 px-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="mt-2 mb-0 text-xs text-text-muted leading-relaxed max-w-[580px]">
              Um framework de alta resolução que desloca a análise do Poker de
              um modelo de &ldquo;estado&rdquo; estático (ICM<sub>ev</sub>) para
              uma análise de &ldquo;fluxo&rdquo; dinâmica, integrando Teoria dos
              Sistemas, Lógica Bayesiana e Psicologia.
            </p>
            <div className="flex items-center gap-3 mt-3">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-accent-indigo/15 border border-accent-indigo/30 text-[0.65rem] font-bold text-accent-indigo-light uppercase tracking-[0.1em]">
      ...
      <div className="max-w-[1200px] mx-auto px-6 pb-12">
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <ul className="ml-6 text-text-main leading-relaxed list-disc">
              <li>
                <strong>ChipEV:</strong> EV<sub>fold</sub> = &minus;antes. O
                piso é negativo. Para uma ação ser coerente, ela não precisa ter
                EV positivo, basta superar o abismo do fold.
              </li>
              <li>
                <strong>O Paradoxo do ICM:</strong> Em bolhas ou payjumps, o EV
                <sub>fold</sub> pode ser <strong>Positivo</strong>{" "}
                (&ldquo;passar a vez&rdquo; gera valor passivo). No pós-flop, o{" "}
                <strong>Pot Entrapment</strong> torna o EV<sub>fold</sub>{" "}
                violentamente negativo (desistir do pote custa exponencialmente
                mais em valuation do que o risco residual). O ICM<sub>ev</sub>{" "}
            ...
            <div className="callout callout-secondary my-8">
              <p className="font-mono text-[0.85rem] text-text-main leading-relaxed mb-2">
                Esperança(ação) = P(win) &times; &Delta;Perspectiva
                <sub>ganho</sub> + P(lose) &times; &Delta;Perspectiva
                <sub>perda</sub>
              </p>
              <p className="mb-0">
                <strong>
        ...
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <p>
              ...
              gigantesco. Na Perspectiva, um EV<sub>fold</sub> negativo é
              superior a um investimento barato insolvente.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="px-8 py-6 rounded-xl bg-slate-900/40 border border-white/5">
          ...
          <ul className="m-0 pl-5 list-disc flex flex-col gap-2 text-[0.7rem] text-text-dim leading-relaxed">
            <li>
              ...
              2019). A quantificação via coeficientes k<sub>A</sub> e expoente b
              é extensão original deste framework.
            </li>
            <li>
