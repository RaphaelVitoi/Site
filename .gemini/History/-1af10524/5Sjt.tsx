          ...
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <ul className="ml-6 text-text-main leading-relaxed list-disc">
              ...
              <li>
                ...
                <strong>O Paradoxo do ICM:</strong>
                {" "}
                Em bolhas ou payjumps, o
                {" "}
                <span className="whitespace-nowrap">
                  {" "}
                  EV<sub>fold</sub>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            <ul className="ml-6 text-text-main leading-relaxed list-disc">
              ...
              <li>
                ...
                <strong>&Delta;RP (Diferencial de Risco):</strong> RP<sub>IP</sub> &minus; RP<sub>OOP</sub>. A subtração representa
