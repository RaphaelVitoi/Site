        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="mt-2 mb-0 text-xs text-text-muted leading-relaxed max-w-145">
              ...
              um modelo de &ldquo;estado&rdquo; estático ({"ICM"}
              <sub>ev</sub>) para uma análise de &ldquo;fluxo&rdquo; dinâmica,
              integrando Teoria dos Sistemas, Lógica Bayesiana e Psicologia. um
              modelo de &ldquo;estado&rdquo; estático (
              <span className="whitespace-nowrap">
                ICM<sub>ev</sub>
              </span>
              ) para uma análise de &ldquo;fluxo&rdquo; dinâmica, integrando
              Teoria dos Sistemas, Lógica Bayesiana e Psicologia.
            </p>
      ...
      <div className="max-w-300 mx-auto px-6 pb-12">
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <ul className="ml-6 text-text-main leading-relaxed list-disc">
              <li>
                <strong>ChipEV:</strong> {"EV"}
                <sub>fold</sub> = &minus;antes. O piso é negativo. Para uma ação
                ser coerente, ela não precisa ter EV positivo, basta superar o
                <strong>ChipEV:</strong> {"EV"}
                <sub>fold</sub> = &minus;antes. O piso é negativo. Para uma ação
                ser coerente, ela não precisa ter EV positivo, basta superar o
                abismo do fold.
              ...
              <li>
                ...
                <strong>Pot Entrapment</strong> torna o {"EV"}
                <sub>fold</sub> violentamente negativo (desistir do pote custa
                exponencialmente mais em valuation do que o risco residual). O{" "}
                {"ICM"}
                <sub>ev</sub> calcula isso como um &ldquo;snapshot&rdquo; (como
                se o torneio acabasse na mão atual).
              </li>
            </ul>
        ...
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-indigo-500/10 rounded-2xl">
          <div className="prose prose-invert prose-lg max-w-none text-slate-300">
            ...
            <p>
              ...
              gigantesco. Na Perspectiva, um {"EV"}
              <sub>fold</sub> negativo é superior a um investimento barato
              insolvente. gigantesco. Na Perspectiva, um{" "}
              <span className="whitespace-nowrap">
                EV<sub>fold</sub>
              </span>{" "}
        ...
        <div className="px-8 py-6 rounded-xl bg-slate-900/40 border border-white/5">
          ...
          <ul className="m-0 pl-5 list-disc flex flex-col gap-2 text-[0.7rem] text-text-dim leading-relaxed">
            <li>
              ...
              2019). A quantificação via coeficientes {"k"}
              <sub>A</sub> e expoente b é extensão original deste framework.
