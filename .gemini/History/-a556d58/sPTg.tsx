...
export default function ScrollToTop () {
    ...
    useEffect( () => {
        const toggleVisibility = () => {
            // Verifica se a página tem pelo menos 1.5x a altura da tela (evita em páginas curtas)
            const isPageLong = document.documentElement.scrollHeight > window.innerHeight * 1.5;

            if ( isPageLong && window.scrollY > 400 )
            {
                setIsVisible( true );
            } else
            {
