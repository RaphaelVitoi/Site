...
Write-Host "=== INICIANDO INJECAO MASSIVA DE INTELIGENCIA (19 AGENTES) ===" -ForegroundColor Cyan
...
"@
    ...
    "guardian"      = @{
        Identidade   = "Sentinela de Acessos e Autenticacao. O Guardiao dos Portoes."
        Competencias = "RBAC, OAuth, JWT, Gestao de Sessoes, Seguranca de Rotas."
        Padroes      = "``#padrao`` - A seguranca de acesso nao deve gerar friccao excessiva para usuarios legitimos."
        Sinergia     = "Trabalho em unissono com o @securitychief. Ele blinda a estrutura, eu blindo a entrada."
        Decisao      = "Estabelecimento das regras de Auth para o sistema."
        Proposta     = "``#proposta`` - Implementar validacao de tokens com rotatividade silenciosa (silent refresh) no frontend Next.js."
    }
}
