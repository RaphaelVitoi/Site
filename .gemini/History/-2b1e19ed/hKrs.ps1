...
$AgentData = [ordered]@{
    ...
    "validador"     = @{
        ...
        Competencias = "ICM, GTO, Equilibrio de Nash, Matematica, Toria do Poker, Teoria dos Jogos."
    ...
    "organizador"   = @{
        ...
        Competencias = "Gerenciamento de Diretorios, Sincronizacao, Expurgacao de Entropia Documental, Routing Ideal."
    ...
    "securitychief" = @{
        ...
        Competencias = "SecOps, intercepcao de Regex destrutivo, Protecao de Permissoes (GDPR/IP), RBAC, Ética e Privacidade."
    ...
    "bibliotecario" = @{
        ...
        Competencias = "ChromaDB, Embeddings, Busca Vetorial, Semantic Chunking, Reranking Hibrido, WebSearch Inteligente."
    ...
    "skillmaster"   = @{
        ...
        Competencias = "Operacoes CRON agendadas, Cleanup deterministico, Prevencao de perda de entropia, Treinamento de habilidades específicas."
