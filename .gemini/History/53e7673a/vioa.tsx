...
function getThemeConfig ( isDeathZone: boolean ) {
  return {
    ...
    gaugeBorderTop: isDeathZone ? '#f43f5e' : '#34d399',
    badgeColor: isDeathZone ? '#f43f5e' : '#818cf8',
    ...
    rpColor: isDeathZone ? '#f43f5e' : '#34d399',
    narrativeBorder: isDeathZone ? '#f43f5e' : '#6366f1',
...
export default function QuantumSynthesis ( {
  ...
  return (
    <div
      className={ `relative mt-6 p-5 sm:p-6 bg-slate-950/60 rounded-3xl overflow-hidden ${isDeathZone ? 'animate-[jitter_0.2s_infinite]' : 'animate-fade-in'}` }
      style={ {
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-5">
        <div className="flex gap-4 items-center">
          {/* Fear Gauge Visual */ }
          <div className="relative w-20 h-11.25 overflow-hidden shrink-0">
            ...
            ></div>
            <div
              className="gauge-needle absolute bottom-0 left-1/2 w-0.5 h-8.75 bg-slate-200 origin-bottom shadow-[0_0_10px_rgba(255,255,255,0.5)]"
