...
function getThemeConfig( isDeathZone: boolean ) {
  return {
    wrapperClass: isDeathZone ? 'border-accent-danger/40 shadow-[0_0_40px_rgba(244,63,94,0.15)] animate-pulse' : 'border-accent-indigo/20 shadow-sota-glass animate-sota-in',
