...
> Foco: Fila de Tarefas (tasks.json) e Persistencia Global
...
| - | ---------- | ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| 1 | CRITICO    | `GLOBAL_INSTRUCTIONS.md`, `MANUAL_WORKFLOW_AGENTES.md` | Inconsistência na identidade do agente ("Chico" vs "GitHub Copilot") e versão do modelo ("Gemini 3 Flash Preview" vs "Gemini 2.5 Flash Preview") | Atualizados `GLOBAL_INSTRUCTIONS.md` e `MANUAL_WORKFLOW_AGENTES.md` para "GitHub Copilot" e "Gemini 2.5 Flash Preview". |
...
- **Gemini 3 Pro Preview**: Modelo único utilizado por todos os agentes (GitHub Copilot), garantindo consistência, velocidade e raciocínio avançado em todas as fases do pipeline.
...
## 3. Workflow Detalhado - Projeto Hipotetico
