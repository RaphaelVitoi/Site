...
- **A Solucao SOTA:** Ao fornecer modificacoes de codigo (`diff` ou scripts completos), a IA DEVE ser cirurgica e extremamente concisa na explicacao textual. NUNCA envie o conteúdo completo de um arquivo longo se apenas algumas linhas foram alteradas; forneça apenas o diff ou divida o envio. A prolixidade causa ruptura de output e falha a integração.
