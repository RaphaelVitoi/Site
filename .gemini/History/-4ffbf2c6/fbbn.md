...
- **Hierarquia de Ação (Anti-Explosão):** A exclusão é o último recurso. A ordem de prioridade para lidar com entropia é sempre: **Fundir > Melhorar > Arquivar > Excluir**.
