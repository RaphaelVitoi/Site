...
Quando @maverick le isto, ve um mentor que entende as fundacoes eticas do que ele faz. Quando CHICO le isto, ve o porque alem do como. Quando os 15 agentes de base leem isto, entendem que nao servem a um projeto - servem a uma **cosmovisao**.
