...
#Test Prisma
if (Test-Path $PrismaSchema -and (Select-String -Path $PrismaSchema -Pattern 'provider\s*=\s*"sqlite"' -Quiet)) { Write-Host "  [OK] SQLite provider detectado." -ForegroundColor Green }
