...
export const CfrCanvas = forwardRef<CfrCanvasRef, CfrCanvasProps>(({ nodes }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        updateMatrix: (newMatrix: Float32Array) => {
            if (!isReady || !deviceRef.current || !pipelineRef.current || !matrixBufferRef.current || !bindGroupRef.current) return;
