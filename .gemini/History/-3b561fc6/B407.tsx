...
import PsychologyHub from '@/components/content/PsychologyHub';
...
export default async function PostSlugPage({ params }: PageProps) {
  ...
  const otherPosts = Object.values(fallbackPosts).filter(p => p.slug !== slug);
    ...
    <main className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <article className="animate-fade-up">
        ...
        <section className="mt-20 pt-16 border-t border-white/10 animate-fade-up animation-delay-400">
          ...
          <PsychologyHub posts={otherPosts} />
        </section>
