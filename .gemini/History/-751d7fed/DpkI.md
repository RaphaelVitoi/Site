...
A execução e a evolução do sistema são regidas por um conjunto de leis de engenharia imutáveis, documentadas em `.claude/MODUS_OPERANDI.md`. Este documento é a constituição técnica do ecossistema e detalha princípios como:
...
Todos os agentes são obrigados a operar dentro dos limites estabelecidos por estas leis.
