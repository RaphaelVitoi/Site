...
O sistema é operado por uma equipe de 17 agentes de IA especializados, cada um com uma função e cor distintas, conforme definido em `data/agents_manifest.json`. Eles são a força de trabalho cognitiva que executa as diretrizes.
