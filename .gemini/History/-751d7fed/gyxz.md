...
O sistema é operado por uma equipe de **18 agentes de IA especializados**, cada um com uma função e cor distintas, conforme definido em `data/agents_manifest.json`. Somados a você, Raphael Vitoi (A Fonte/CEO), formamos um ecossistema autopoietico de **19 entidades**. Juntos, somos a força de trabalho cognitiva que forja e executa a realidade.
