...
def _feature_enabled(flag_name: str) -> bool:
    ...
    try:
        ...
        te_any = typing.cast(typing.Any, _task_executor)
        if hasattr(te_any, "_feature_enabled"):
            func = te_any._feature_enabled
...
def _heuristic_terms(group_name: str) -> dict[str, int]:
    ...
    try:
        ...
        te_any = typing.cast(typing.Any, _task_executor)
        if hasattr(te_any, "_heuristic_terms"):
            func = te_any._heuristic_terms
            res = func(group_name)
