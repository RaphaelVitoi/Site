            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-4 max-w-3xl">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-linear-to-r from-text-bright via-text-muted to-text-darker tracking-tighter leading-[1.1]">
                            { title }
                        </h1>
