...
export function MonopolyVectorPanel () {
    ...
    // < 1.0 (Vermelho - Entropia/Déficit), >= 1.0 (Verde - Simetria/Monopólio)
    const isEntropy = monopolyVector < 1.0;
    ...
    return (
        <div className="w-full bg-zinc-950 border border-zinc-800/80 rounded-lg p-5 mt-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-linear-to-b from-transparent to-white/[0.02] pointer-events-none" />
        </div>
    );
}
