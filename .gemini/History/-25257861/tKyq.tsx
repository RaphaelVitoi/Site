...
const timeline = [
  {
    epoch: 'Pré-flop',
    title: 'RP Máximo',
    copy: 'Stack inteiro em risco. RP opera com força total — cada chip perdido remove mais $EV do que cada chip ganho adiciona. Drift comprime 3-bets e opens.',
  },
  {
    epoch: 'Flop / Turn',
    title: 'RP Residual',
    copy: 'O pote cresceu em relação ao stack. RP dissipa proporcionalmente ao SPR. O solver raciocina sobre o pote isolado; o ICM raciocina sobre o torneio inteiro.',
  },
  {
    epoch: 'River',
    title: 'Convergência ChipEV',
    copy: 'RP residual mínimo. O jogo converge ao ChipEV — mas o stack que chegou aqui é produto das decisões das streets anteriores. O edge acumulou antes.',
  },
];
...
const pillars = [
  {
    ...
    copy: '93 nodes HRC vs GTO Wizard (Aula 1.2, board KJT-2-3). Único ponto de calibração real. Demais cenários são extrapolações didáticas.',
  ...
  },
  {
    ...
    copy: 'RP, ΔRP, Perspectiva e Esperança Matemática — conceitos de Raphael Vitoi. Downward Drift: O\'Kearney & Carter, estendido e quantificado.',
    icon: 'fa-compass',
    tag: 'ORIG',
  ...
  },
  {
    ...
    copy: 'O Motor ICM aplica este framework em tempo real: escolha um cenário, ajuste RP e agressão, veja as seis frequências ICM e o desvio do ChipEV.',
    icon: 'fa-layer-group',
    tag: 'LAB',
...
const callouts = [
  {
    ...
    type: 'secondary',
    lines: [
      'OOP com alto RP perde mais do que ganha: chips perdidos valem mais em $EV do que chips ganhos.',
      'O fold passa a ser matematicamente obrigatório acima da frequência de equilíbrio ChipEV — Esperança ICM do call é negativa.',
    ],
  },
  {
    ...
    type: 'neutral',
    lines: [
      'RP alto comprime blefes e apostas grandes. A agressão migra para sizings menores ou desaparece — Downward Drift em cascata.',
      'Heurística: cada 5% de RP reduz o sizing ótimo em aproximadamente 1/3 de pot. A 20% RP, overbets desaparecem.',
    ],
  },
  {
    title: 'Dissipação por Street',
    type: 'emerald',
    lines: [
      'Pré-flop: RP máximo → Drift máximo. 3-bets colapsam, opens encolhem.',
      'Flop/Turn: RP residual proporcional ao SPR. Check-backs sobem, sizings encolhem.',
      'River: jogo converge ao ChipEV. O edge foi capturado nas streets anteriores.',
    ],
  },
];
