    ...
    <main className={ styles.page }>
      <header className={ styles.hero }>
        ...
        <div className={ styles.heroActions }>
          ...
          <Link href="/motor-icm" className={ `btn-secondary ${ styles.heroButton }` }>
          <Link href="/simulador-icm" className={ `btn-secondary ${ styles.heroButton }` }>
      ...
      <section className={ styles.arsenal } id="arsenal">
        ...
        <div className={ styles.navGrid }>
          ...
          <Link href="/motor-icm" className={ styles.navCard }>
          <Link href="/simulador-icm" className={ styles.navCard }>
      ...
      <nav className={ `${ styles.articleNav } article-nav` }>
        ...
        <Link href="/aulas/icm-pos-flop">Aula 1.2 <i className="fa-solid fa-arrow-right" style={ { marginLeft: '4px' } } /></Link>
      </nav>
    </main>
  );
}
