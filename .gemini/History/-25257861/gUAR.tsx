  ...
  return (
    <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body pb-24">
      ...
      <div className="sota-container -mt-8 pb-12">
        <blockquote className="border-l-4 border-accent-indigo pl-8 py-4 italic text-text-muted text-xl bg-white/[0.02] rounded-r-2xl">
      ...
      <div className="sota-container pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          { metrics.map( ( metric ) => (
            <div key={ metric.label } className="p-6 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-accent-indigo/30 transition-all group">
