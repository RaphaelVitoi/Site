  ...
  return (
    <main className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <article className="animate-fade-up">
        ...
        <div className="glass-panel p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl shadow-emerald-500/10 rounded-2xl animate-fade-up animation-delay-200">

          {/* Seção de Métricas */}
          <section className="mb-20">
            <header className="mb-10">
              <p className="font-mono text-sm uppercase tracking-widest text-emerald-400 mb-3 flex items-center">
                <i className="fa-solid fa-radar mr-3" /> Grandezas do Sistema
              </p>
              <h2 className="text-3xl font-bold tracking-tight font-heading text-white sm:text-4xl text-balance mb-4">
                Quatro números que organizam o pós-flop de mesa final.
              </h2>
              <p className="text-lg leading-relaxed text-slate-400 text-balance max-w-3xl">
          ...
          {/* Artigo Principal */}
          <section className="prose prose-invert prose-lg max-w-none mb-20 text-slate-300">
          ...
          <section className="mb-20 pt-10 border-t border-white/5">
            <header className="mb-10">
              <p className="font-mono text-sm uppercase tracking-widest text-emerald-400 mb-3 flex items-center">
                <i className="fa-solid fa-chess-knight mr-3" /> Padrões Comportamentais
              </p>
          ...
          <section className="pt-10 border-t border-white/5">
            <header className="mb-10">
              <p className="font-mono text-sm uppercase tracking-widest text-emerald-400 mb-3 flex items-center">
                <i className="fa-solid fa-compass mr-3" /> Navegação
              </p>
              <h3 className="text-3xl font-bold font-heading text-white">Continuar o Estudo</h3>
            </header>
