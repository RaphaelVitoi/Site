"""
Gerenciamento e persistência de dados experimentais e cenários SOTA (Lab Manager).
"""
...
class LabManager:
    """
    Gerenciador SOTA para os laboratórios e cenários de testes quantitativos.
    """
