...
Comando: `powershell.exe -ExecutionPolicy Bypass -File "scripts/routines/send_alert.ps1" -Level "SEU_NIVEL_AQUI" -Title "Auditoria Semanal" -Message "Resumo em 1 frase da conclusao."`
"@
