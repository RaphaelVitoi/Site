...
from frontend.src.app.engine.llm_api import call_llm_api
from frontend.src.app.engine.god_mode import apply_god_mode
...
async def process_agent_task(task: Task, manager: QueueManager):
    ...
    await apply_god_mode(response_text)  # type: ignore
