                ...
                <div class="col-span-1 md:col-span-2 bg-slate-900/40 border border-white/5 rounded-xl p-4 flex items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="number" id="sim-equity-input" placeholder="Equity (Ex: 45)" class="bg-transparent border-b border-slate-600 text-white text-sm w-24 focus:outline-none focus:border-indigo-500 transition-colors font-mono" min="0" max="100">
