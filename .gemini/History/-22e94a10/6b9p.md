...
26. **Smart MDA e Auditoria Adaptativa (Anti-Smoothing):** Para auditoria e apuracao, os dados devem ser cruzados de forma profissional e escalavel. O usuario ou o proprio sistema podem disparar auditorias sob demanda (`do.ps1 -Audit "Cenario"`). Os relatorios gerados devem ser puramente analiticos, hibridos (quantitativo/qualitativo), didaticos e esteticamente refinados. O uso de "smoothing" (passar pano para erros), enviesamento ou alucinacao e considerado violacao critica. A verdade factual e exposta friamente. A relacao e fractal: a Parte entende sua funcao no Todo.
