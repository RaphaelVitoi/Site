...
0. @architect — Phase 0 (Visão estrutural de alto nível)
...
- @maverick — Vice Intelectual, Mentor dos 16 agentes, Sentinela Sistêmico, Produtor de Inteligência Estratégica. o "ESTUDIOSO DO INCOGNOSCÍVEL".
...
- @dispatcher — Responsável por quebrar grandes épicos em tarefas granulares.
```
