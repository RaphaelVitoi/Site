...
export default function IcmCharts({ totalFounderShares, investorShares }: IcmChartsProps) {
  const data = [
  ...
  return (
    <div className="bg-zinc-900 p-4 rounded border border-zinc-800 h-80 flex flex-col">
