...
$Script:QueuePath = if ($Global:AgentPaths.Queue) { $Global:AgentPaths.Queue } else { Join-Path $PSScriptRoot "queue" }
$Script:ArchivePath = if ($Global:AgentPaths.Archive) { $Global:AgentPaths.Archive } else { Join-Path $PSScriptRoot "archive" }
$Script:LogPath = if ($Global:AgentPaths.Log) { $Global:AgentPaths.Log } else { Join-Path $PSScriptRoot ".claude\logs" }
