...
$Agents = @(
    "dispatcher", "architect", "planner", "maverick", "auditor", "implementor", 
    "verifier", "curator", "validador", "organizador", "pesquisador", 
    "prompter", "securitychief", "bibliotecario", "sequenciador", "skillmaster", "chico"
    "verifier", "curator", "validador", "organizador", "pesquisador", "prompter", 
    "securitychief", "bibliotecario", "sequenciador", "skillmaster", "historian", "chico"
)
