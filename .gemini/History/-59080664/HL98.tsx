...
export function UniversalLabShell ( { initialSpot }: UniversalLabShellProps ) {
    ...
    const [ spot, setSpot ] = useState<SpotState>( initialSpot ?? { heroInvested: 0, pot: 0, activePlayers: 2 } );
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-4 mb-2">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input
                                            ...
                                            onChange={ ( e ) => setSpot( s => ( { ...s, heroInvested: parseFloat( e.target.value ) || 0 } ) ) }
                                        />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input
                                            ...
                                            className="bg-black/40 border border-zinc-800 rounded p-2.5 text-white font-mono text-sm focus:outline-hidden focus:border-emerald-500 transition-colors"
                                            value={ spot.pot }
                                            onChange={ ( e ) => setSpot( s => ( { ...s, pot: parseFloat( e.target.value ) || 0 } ) ) }
                                        />
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    onClick={ () => {
                                        if ( workerRef.current )
                                        {
                                            ...
                                            const buffer = new Float32Array( [ spot.heroInvested, spot.pot ] );
