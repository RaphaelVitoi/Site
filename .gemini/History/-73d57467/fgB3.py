...
def test_rio_risk_calculation():
    ...
    # RIO Tension calculado pelo motor v4.6: 0.341
    # Ci calculado pelo motor v4.6: 0.74 (FOLD)
...
def test_rio_risk_high_passivity_low_odds():
    ...
    # RIO Tension calculado pelo motor v4.6: 0.563
    # Ci calculado pelo motor v4.6: 0.77 (FOLD)
