        ...
        <GlassPanel className="p-8 sm:p-12 lg:p-16">
          <div className="prose prose-invert prose-lg max-w-none text-text-muted font-body">
            ...
            <figure className="my-10 group">
              ...
              <figcaption className="text-center text-xs text-text-dim mt-4 uppercase tracking-widest font-mono">
            ...
            <figure className="my-10 group">
              ...
              <figcaption className="text-center text-xs text-accent-rose-light mt-4 uppercase tracking-widest font-mono font-bold">
