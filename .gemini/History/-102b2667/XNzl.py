...
async def call_openrouter(session: aiohttp.ClientSession, model: str, system_prompt: str, user_prompt: str, api_key: str, timeout: Optional[aiohttp.ClientTimeout] = None, require_json: bool = False, **kwargs) -> Tuple[str, dict]:
