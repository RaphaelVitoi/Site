...
export function DownwardDriftSimulator() {
    ...
    const { potEntrapment, chartData, crossoverPoint } = useMemo( () => {
        ...
        for ( let invested = 0; invested <= physics.heroStack; invested += 2 ) {
            ...
            if (multiwayRioMatrix) {
                ...
                // Multiway base: Mapeia O(1) no tensor f32 array o cenário de 3 jogadores
    ...
    }, [physics.heroInvested, physics.pot, physics.heroStack, baseRioLiability, physics.referenceStatus, multiwayRioMatrix] );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-6 bg-black/20 p-6 rounded-2xl border border-white/5">
                    <div className="space-y-2">
                        ...
                        <input type="range" min="10" max="100" value={ physics.heroStack } onChange={ e => updatePhysics( { heroStack: Number( e.target.value ) } ) } className="w-full h-1 bg-white/10 rounded-full appearance-none accent-accent-indigo cursor-pointer" />
                    </div>
                    <div className="space-y-2">
                        <div className="flex justify-between items-end mb-1">
