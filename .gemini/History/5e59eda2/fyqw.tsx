...
export function DownwardDriftSimulator() {
    ...
    if ( !isMounted || !isHydrated ) {
        return (
            <div className="glass-panel p-8 flex flex-col items-center justify-center min-h-[500px] border-accent-indigo/10 max-w-5xl mx-auto bg-black/20 animate-pulse rounded-2xl">
