            ...
            async def _get_notify_table():
                ...
                if "--json" in argv:
                    ...
                    for t in notify_tasks:
                        ...
                        # SOTA: Busca erro do AUTOFIX referenciado
                        ...
                        if ref_task_id and ref_task_id.startswith("AUTOFIX"):
                            ...
                            if ref_task and ref_task.metadata and ref_task.metadata.get("last_error_message"):
                                err_msg = ref_task.metadata.get("last_error_message").replace('\n', ' ')
