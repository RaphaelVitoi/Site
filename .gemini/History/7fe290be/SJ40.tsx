...
export default function ArticleHeader ( {
  ...
  return (
    <header className="page-header text-center mb-12 animate-fade-up">
      ...
      <div className="mt-8 inline-flex flex-wrap justify-center items-center gap-4 text-xs font-mono text-slate-400 uppercase tracking-widest bg-slate-900/50 border border-white/5 rounded-full px-6 py-3 shadow-inner">
