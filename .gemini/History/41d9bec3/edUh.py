...
async def _forge_files(text: str, effective_mode: str, agent_name: str) -> List[str]:
    ...
    for match in re.finditer(pattern, text, re.DOTALL | re.IGNORECASE):
        ...
        try:
            ...
            if is_protected:
                if effective_mode == "full" and agent_name == "@chico":
...
async def _execute_commands(text: str, effective_mode: str, agent_name: str) -> None:
    ...
    for match in re.finditer(cmd_pattern, text, re.DOTALL | re.IGNORECASE):
        ...
        # [GOD MODE W3 / W2.5] Liberação de Encadeamento de Comandos apenas para Tier 1 e Tier 2.
        ...
        # [TIER 3 / W2] Permite leitura e execução segura, mas bloqueia mutação de ecossistema
...
async def apply_god_mode(text: str, manager: QueueManager, agent_name: str = None) -> List[str]:
    """
