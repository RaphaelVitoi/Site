...
function Invoke-AgentPlanner {
    ...
    if ($myTask) {
        ...
        # Prioriza o 'slug' dos metadados para desacoplar a lógica do formato do ID.
...
function Start-OrganismPulse {
    ...
    while ($true) {
        Invoke-AgentWithRetry -AgentAction { Invoke-AgentMaverick } -AgentName "@maverick"
        Invoke-AgentWithRetry -AgentAction { Invoke-AgentPlanner } -AgentName "@planner"
        Invoke-AgentWithRetry -AgentAction { Invoke-AgentAuditor } -AgentName "@auditor"
