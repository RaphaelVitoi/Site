...
## 6. FRAMEWORK SENTINEL-v1 (Restrições)
...
- [ ] **Otimização GTO:** Implementar a solução mais eficiente matematicamente.
- [ ] **Verdade Nua:** Documentar dívida técnica e rationale nos comentários (# HACK).
- [ ] **Simetria Operacional:** Scripts devem fornecer diagnósticos acionáveis em falhas.

## 7. PROPOSTAS DEMOCRATICAS (Inovacao Sistemica) (#proposta)
...
_A evolucao do Todo comeca na precisao e integridade da Parte._
