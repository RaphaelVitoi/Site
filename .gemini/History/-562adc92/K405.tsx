...
export default async function AnalyticsPage () {
    ...
    return (
        <div className="min-h-screen p-8 text-white flex flex-col items-center">
            ...
            { dbError ? (
                <main className="w-full max-w-5xl flex flex-col items-center justify-center p-10 bg-red-900/10 border border-red-500/20 rounded-2xl backdrop-blur-md">
                    <h2 className="text-red-400 text-xl font-bold mb-4 uppercase tracking-widest">Falha Termodinâmica</h2>
                    <p className="text-white/70 text-center max-w-lg">O núcleo de dados local encontra-se inacessível. O Panóptico SOTA não pode processar o Sangramento de EV. Verifique a instância do banco Prisma.</p>
                </main>
            ) : (
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="w-full h-4 bg-black/40 rounded-full overflow-hidden border border-white/5 shadow-inner">
                                                <div
                                                    className="h-full bg-linear-to-r from-red-600 to-red-400 rounded-full transition-all duration-1000 ease-out group-hover:brightness-125"
