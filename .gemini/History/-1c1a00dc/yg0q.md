...
### 🔹 FASE 0.5: O Batedor Avançado (@pesquisador)
...
### 🔹 FASE 1: A Ponte Semântica (@prompter)
...
### 🔹 FASE 3: O Bloqueador Linear (@auditor)
...
### 🔹 FASE 4: A Força Bruta (@implementor)
...
### 🔹 FASE 5: O Sentinela de Qualidade (@verifier)
