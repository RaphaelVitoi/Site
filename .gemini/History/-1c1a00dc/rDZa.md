...
| --- | ---------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | CRITICO    | `GLOBAL_INSTRUCTIONS.md`, `MANUAL_WORKFLOW_AGENTES.md` | Inconsistencia na identidade do agente ("Chico" vs "GitHub Copilot") e versao do modelo | Atualizados `GLOBAL_INSTRUCTIONS.md` e `MANUAL_WORKFLOW_AGENTES.md` para "GitHub Copilot" e "Gemini 3 Pro Preview" (modelo prioritario). |
...
> **Para visao arquitetonica completa dos 19 agentes e pipeline, consulte `.claude/project-context.md`**
>
...
O sistema possui capacidade de auto-regulacao e producao continua atraves do script `start_life.ps1`.
