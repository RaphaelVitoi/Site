...
3.  **Executar Comando:** `cd frontend ; npm install prisma @prisma/client`
4.  **Executar Comando:** `cd frontend ; npx prisma init`
5.  **Materializar Arquivos:** Criar o arquivo `frontend/prisma/schema.prisma` com o schema acima.
6.  **Materializar Arquivos:** Criar a estrutura de rotas vazias no NextJS.
