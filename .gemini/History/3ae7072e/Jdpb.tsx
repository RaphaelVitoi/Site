  ...
  return (
    <div className={ styles.glassPanel } style={ PANEL_STYLE }>
      ...
      <div style={ { display: 'flex', flexDirection: 'column', gap: '0.4rem' } }>
        ...
        <div style={ { ...LAYER_STEP, borderLeftColor: '#818cf8', background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.3)', padding: '1rem' } }>
          ...
          { Math.abs( result.perspectivaPct ) <= 5 && (
            <div style={ { marginTop: '0.6rem', padding: '0.4rem', background: 'rgba(244, 63, 94, 0.1)', border: '1px solid rgba(244, 63, 94, 0.3)', borderRadius: '6px', fontSize: '0.45rem', color: '#f472b6', fontWeight: 800 } }>⚠️ ZONA MARGINAL (EV INSTÁVEL): Decisão altamente sensível à imprecisão de range do oponente.</div>
          ) }
      ...
      <div style={ { padding: '0.75rem', background: 'rgba(99,102,241,0.05)', borderLeft: '3px solid #6366f1', borderRadius: '4px', fontSize: '0.5rem', color: '#cbd5e1', lineHeight: 1.6 } }>
        ...
        { isNearPayjump && <div style={ { marginTop: '0.5rem', color: '#fbbf24', fontWeight: 700 } }>[EXTREMA AVERSÃO AO RISCO]: A pressão de payjump induz o overfold. EVs negativos da teoria pura podem sofrer inversão pela alta taxa de desistência.</div> }
      </div>
    </div>
  );
}
