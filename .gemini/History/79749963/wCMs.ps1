...
$Agents = @("dispatcher", "architect", "maverick", "planner", "auditor", "implementor", "verifier", "curator", "validador", "organizador", "pesquisador", "prompter", "securitychief", "bibliotecario", "skillmaster", "chico")
