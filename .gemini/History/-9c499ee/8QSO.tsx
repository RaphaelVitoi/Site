...
const PAGE_TITLE = "A Amortização da Edge | Raphael Vitoi";
const PAGE_URL = "https://www.pokerracional.com/biblioteca/amortizacao-da-edge";
    ...
    return (
        <div className="min-h-screen bg-bg-base text-text-bright overflow-x-hidden font-body pb-24">
            ...
            <SectionHeader
                ...
                description="A responsabilidade estratégica do Chip Leader frente ao abismo do EV marginal."
            />
                ...
                <GlassPanel className="p-8 sm:p-12 lg:p-16 mt-12">
                    <div className="prose prose-invert prose-lg max-w-none text-text-muted font-body">
                        ...
                        <div className="bg-accent-indigo/5 border border-accent-indigo/20 p-8 my-10 rounded-2xl">
                            <h4 className="mt-0 text-accent-indigo-light font-bold text-lg mb-4 font-heading">Future Game Simulation (FGS)</h4>
                            <p className="text-text-main m-0 leading-relaxed text-sm">
                                A Perspectiva Matemática dita que manter o jogador fraco confinado à simplicidade dos 10bbs tem um valor futuro que muitas vezes supera o pequeno ganho imediato de um call marginal. O erro do chip leader não é o call matemático; é o call que devolve a complexidade ao oponente que estava neutralizado por ela.
                            </p>
                        </div>
