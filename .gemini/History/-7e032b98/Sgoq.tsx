...
export default function MasterSimulator () {
    ...
    const baseFgsErosion = useMemo(
        () => _calculateBaseFgsErosion( quantumPerspectiva, blindsRisingSoon, anteSize, heroPosition, heroRawStack, totalTableChips ),
    ...
    const actionMetrics = useMemo( () => {
        return _calculateActionMetrics( { heroInvested, currentPot, bfForDash, rpForDash, quantumPerspectiva, heroRawStack, heroPosition, baseFgsErosion, apiQuantumMetrics, activePlayers, totalTableChips } );
    }, [ heroInvested, currentPot, bfForDash, rpForDash, quantumPerspectiva, isBaseline, heroRawStack, heroPosition, baseFgsErosion, apiQuantumMetrics, activePlayers, totalTableChips ] );
