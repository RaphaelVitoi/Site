                    ...
                    <div className={ styles.simRoot }>
                        ...
                        <Suspense fallback={ <LoadingFallback /> }>
                            <div style={ { maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem' } }>
                                <PmLensPanel anteSize={ anteSize } heroInvested={ heroInvested } currentPot={ currentPot } activePlayers={ activePlayers } heroPosition={ heroPosition } blindsRisingSoon={ blindsRisingSoon } />
                                <IcmQuizVisceral />
                            </div>
                        </Suspense>
