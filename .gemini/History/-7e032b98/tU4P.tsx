...
export default function MasterSimulator() {
    ...
    const apiQuantumMetrics = useMemo( () => (
        quantumPerspectiva ? computeQuantumMetrics( quantumPerspectiva as any, activePlayers, heroInvested, currentPot, scenario.stacks, heroRawStack, totalTableChips, nativeRangeMetric.equity, kappa ) : null
