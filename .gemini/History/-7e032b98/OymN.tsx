...
import type { ChipEvFreqs, Scenario, StreetChipEvFreqs } from './engine/types';
...
const SimulatorQuizWidget = lazy( () => import( '../quiz/SimulatorQuizWidget' ).then( m => ( { default: m.SimulatorQuizWidget as React.ComponentType<any> } ) ) );
...
export default function MasterSimulator() {
    ...
    const totalTableChips = useMemo( () => scenario.stacks.reduce( ( acc: number: num: numberber, val: number ) => acc + val, 0 ), [scenario.stacks] );
