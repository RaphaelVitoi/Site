    ...
    return (
        <div className="flex flex-col gap-20 animate-sota-in">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_1fr] gap-12 items-stretch">
                <div className="glass-panel p-10 lg:p-12 rounded-4xl bg-bg-panel/60 border border-white/5 shadow-2xl relative overflow-hidden group/insolvency-wrap">
                    ...
                    <div className="flex items-center justify-between mb-12 border-b border-white/5 pb-6">
                        <div className="flex items-center gap-4">
                            <div className="w-2.5 h-2.5 rounded-full bg-accent-indigo animate-pulse shadow-[0_0_10px_var(--accent-indigo)]" />
                            <h3 className="text-[0.75rem] font-black text-white uppercase tracking-[0.4em] m-0">Matriz de Insolvência SOTA</h3>
                        </div>
                        <span className="text-[0.55rem] font-black text-text-darker uppercase tracking-[0.3em]">Quantum Telemetry</span>
                    </div>
                    <InsolvencyMatrix />
                </div>

                <div className="glass-panel p-10 lg:p-12 rounded-4xl bg-bg-panel/60 border border-white/5 shadow-2xl flex flex-col justify-between relative overflow-hidden group/pm-guide">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-12 h-12 rounded-2xl bg-accent-indigo/10 border border-accent-indigo/20 flex items-center justify-center text-accent-indigo-light">
                            {session?.user?.image ? (
                            ...
                            <div>
                                <h3 className="text-sm font-black text-white uppercase tracking-[0.2em] m-0">Perspectiva Matemática</h3>
                            <p className="text-[0.6rem] text-text-darker font-black uppercase tracking-widest mt-1">Operador: <span className="text-accent-indigo-light">{userName}</span></p>
                            </div>
                        </div>
                        <p className="text-[0.85rem] text-text-muted leading-relaxed font-medium italic border-l-2 border-accent-indigo/30 pl-6 py-2">
                    ...
                    <div className="mt-10 pt-8 border-t border-white/5">
                        <div className="flex items-center justify-between">
                            <span className="text-[0.6rem] font-black text-text-darker uppercase tracking-[0.3em]">Status da Mente</span>
                            <span className="px-3 py-1 rounded-lg bg-accent-indigo/10 text-accent-indigo-light text-[0.55rem] font-black uppercase tracking-widest border border-accent-indigo/20">Calibrada</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="glass-panel p-10 rounded-4xl bg-bg-panel/40 border border-white/5 shadow-2xl flex flex-col items-center justify-between group/vulnerabilities">
                        ...
                        <div className="w-full mt-10 space-y-6">
                            <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                                <i className="fa-solid fa-microchip text-accent-indigo text-xs"></i>
                                <h4 className="text-[0.6rem] font-black text-text-muted uppercase tracking-[0.2em] m-0">Top Leaks (IA Preditiva)</h4>
                            </div>
