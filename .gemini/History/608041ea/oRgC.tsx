    ...
    return (
        <div className="flex flex-col gap-20 animate-sota-in">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_1fr] gap-12 items-stretch">
                <div className="glass-panel p-10 lg:p-12 rounded-4xl bg-bg-panel/60 border border-white/5 shadow-2xl relative transition-all duration-700 hover:border-white/20 group/insolvency-wrap">
                    ...
                    <div className="flex items-center justify-between mb-12 border-b border-white/5 pb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <h3 className="text-[0.75rem] font-black text-white uppercase tracking-[0.4em] m-0 relative z-10">Matriz de Insolvência SOTA</h3>
                        </div>
                        <span className="text-[0.55rem] font-black text-text-darker uppercase tracking-[0.3em] relative z-10">Quantum Telemetry</span>
                    </div>
                    <InsolvencyMatrix />
                </div>

                <div className="glass-panel p-10 lg:p-12 rounded-4xl bg-bg-panel/60 border border-white/5 shadow-2xl flex flex-col justify-between relative transition-all duration-700 hover:border-white/20 group/pm-guide">
                    <div className="absolute inset-0 overflow-hidden rounded-4xl pointer-events-none">
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-12 h-12 rounded-2xl bg-accent-indigo/10 border border-accent-indigo/20 flex items-center justify-center text-accent-indigo-light relative overflow-hidden">
