...
export function GtoCfrContent ( props: GtoCfrContentProps )
{
    return (
        <Suspense fallback={ <div className="sota-container mt-8 text-center text-text-dim text-xs uppercase tracking-widest animate-pulse">Sincronizando Telemetria Quântica...</div> }>
