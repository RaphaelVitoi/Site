    ...
    if ( this.state.hasError )
    {
      ...
      return (
        <div style={ {
          ...
          <h2 style={ { color: 'var(--accent-rose)', fontSize: '1.2rem', marginBottom: '1rem' } }>
          ...
          <p style={ { marginBottom: '1rem', fontSize: '0.9rem', color: 'var(--text-light)' } }>
            A termodinâmica do simulador sofreu uma falha crítica. A equipe SOTA já foi notificada através do sistema de telemetria.
          </p>
          <button
