...
export function NashConvergenceMatrix ( { matrixData, isDynamicRpActive }: Readonly<NashConvergenceMatrixProps> ) {
    ...
    return (
        <div className="flex flex-col items-center w-full max-w-3xl mx-auto space-y-6">
            ...
            <div className="w-full min-h-[8rem] bg-zinc-950 border border-zinc-800/80 rounded-xl p-4 flex flex-col justify-center overflow-hidden relative">
                <AnimatePresence mode="wait">
                    { hoveredCell ? (
                        <motion.div
                            ...
                            className="flex flex-col sm:flex-row w-full items-center justify-between gap-4 sm:gap-0"
                        >
