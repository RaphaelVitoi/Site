...
interface NashConvergenceMatrixProps {
    matrixData: NashCellData[];
    isDynamicRpActive: boolean; // Controla se o Filtro Vitoi (Insolvência) está ligado
}

export function NashConvergenceMatrix ( { matrixData, isDynamicRpActive }: NashConvergenceMatrixProps ) {
        ...
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto space-y-6">
            ...
            <div className="w-full relative aspect-square max-h-[70vh] bg-zinc-950 p-2 rounded-xl border border-zinc-800/50 shadow-2xl">
                <div className="grid grid-cols-13 gap-[1px] w-full h-full">
                  ...
                  border rounded-[2px] transition-colors duration-300 cursor-pointer
                  ${appearance}
                `}
