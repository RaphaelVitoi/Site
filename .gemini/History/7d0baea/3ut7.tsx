      ...
      <div className="sota-container -mt-12 relative z-10 max-w-4xl">
        ...
        >
          ...
          <div className="relative">
            ...
            />
            <div className="absolute right-4 bottom-4 flex items-center gap-6">
              <label className="flex items-center gap-2 text-[0.6rem] text-text-muted font-black uppercase tracking-widest cursor-pointer hover:text-white transition-colors select-none">
                <input
                  type="checkbox"
                  checked={forceRAG}
