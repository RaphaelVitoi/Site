...
archive_dir = BASE_DIR / ".claude/.archive"
...
AGENT_SOURCE = str(BASE_DIR / "data/agents_manifest.json")
...
if not AGENTS_MANIFEST:
    ...
    AGENT_SOURCE = str(BASE_DIR / "data/intentmap.json")
...
_intentmap_path = BASE_DIR / "data/intentmap.json"
...
ROUTING_MAP = load_json_config(BASE_DIR / "data/routing_map.json", {})
...
def _reload_agents_manifest() -> bool:
    ...
    manifest_path = BASE_DIR / "data/agents_manifest.json"
    try:
